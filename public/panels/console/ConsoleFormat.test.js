...
describe('ConsoleFormat', () => {
    ...
    describe('updateStyle', () => {
        ...
        it('blocks block-listed url schemes in values', () => {
            ...
            assert.isFalse(styles.has('background-image'));
            Console.ConsoleFormat.updateStyle(styles, 'background-image:if(supports():"url(data:";else:url(http://localhost/a.png))');
            assert.isFalse(styles.has('background-image'));
            ...
            assert.isFalse(styles.has('background-image'));
            Console.ConsoleFormat.updateStyle(styles, 'background-image:if(else:image\\-set("data:" 1x, "http://localhost/a.png" 2x))');
            assert.isFalse(styles.has('background-image'));
            Console.ConsoleFormat.updateStyle(styles, 'background-image:if(else:image-se\\74 ("data:" 1x, "http://localhost/a.png" 2x))');
            assert.isFalse(styles.has('background-image'));
        ...
        it('allows data urls in values', () => {
            ...
            Console.ConsoleFormat.updateStyle(styles, `background-image:image-set( "${dataUrl}" 1.5x , url("${dataUrl}") type( "image/png" ) )`);
            assert.include(styles.get('background-image').value, 'data:image/png;base64');
        });
    });
});
