...
describe('SymbolizedErrorWidget', function () {
    ...
    async function createError(stack, causeStack) {
    ...
    it('correctly renders a complex nested eval stack trace', async () => {
        ...
        const scriptId = '1';
        debuggerModel.parsedScriptSource(scriptId, urlString `http://example.com/index.html`, 0, 0, 0, 0, executionContextId, '', undefined, false, undefined, false, false, 0, false, null, null, null, null, null, null);
