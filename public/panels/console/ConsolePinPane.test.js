...
describeWithEnvironment('ConsolePinPane', () => {
    ...
    describe('Self-XSS Protection', () => {
        ...
        async function pasteIntoLiveExpression(consolePinPane) {
            const pins = consolePinPane.element.shadowRoot?.querySelectorAll('.console-pin');
            const codeMirror = pins?.[0]?.querySelector('devtools-text-editor')?.shadowRoot?.querySelector('.cm-content') || null;
...
//# sourceMappingURL=ConsolePinPane.test.js.map