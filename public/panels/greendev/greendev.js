...
// gen/front_end/panels/greendev/GreenDevPanel.js
var GreenDevPanel_exports = {};
__export(GreenDevPanel_exports, {
  GreenDevPanel: () => GreenDevPanel
});
...
var GreenDevPanel_css_default = `/* eslint-disable color-named, no-duplicate-selectors */
...
/*# sourceURL=${import.meta.resolve("./GreenDevPanel.css")} */`;

// gen/front_end/panels/greendev/GreenDevPanel.js
var greenDevPanelInstance;
var GreenDevPanel = class _GreenDevPanel extends UI.Panel.Panel {
  #tabbedPane;
  ...
  wasShown() {
    super.wasShown();
    this.registerRequiredCSS(GreenDevPanel_css_default);
  ...
  static instance(opts = { forceNew: null }) {
    ...
    if (!greenDevPanelInstance || forceNew) {
      greenDevPanelInstance = new _GreenDevPanel();
    }
...
export {
  GreenDevPanel_exports as GreenDevPanel
};
