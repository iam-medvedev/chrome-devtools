...
async function getDialogAndEditor(editorLineNumber, oldCondition, isLogpoint, onFinish) {
    ...
    dialog.breakpointType =
        isLogpoint ? "LOGPOINT" /* SDK.DebuggerModel.BreakpointType.LOGPOINT */ : "CONDITIONAL_BREAKPOINT" /* SDK.DebuggerModel.BreakpointType.CONDITIONAL_BREAKPOINT */;
