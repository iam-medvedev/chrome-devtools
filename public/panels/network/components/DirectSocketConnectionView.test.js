...
describeWithEnvironment('DirectSocketConnectionView', () => {
    ...
    describe('Category toggle', () => {
        it('opens', async () => {
            view.input.onToggleCategory({ target: { open: true } }, categoryName);
            assert.isTrue((await view.nextInput).openCategories.includes(categoryName));
        });
        it('closes', async () => {
            view.input.onToggleCategory({ target: { open: false } }, categoryName);
    ...
    describe('Handles arrow keys on category', () => {
        ...
        it('does nothing if target is absent', async () => {
            ...
            view.input.onSummaryKeyDown({ key: 'ArrowLeft' }, categoryName);
            assert.isTrue((await view.nextInput).openCategories.includes(categoryName));
        });
...
//# sourceMappingURL=DirectSocketConnectionView.test.js.map