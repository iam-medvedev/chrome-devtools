...
describeWithEnvironment('RequestBinaryResponseView', () => {
    ...
    it('shows the initial content of a StreamingContentData', async () => {
        const streamingContentData = TextUtils.StreamingContentData.StreamingContentData.from(new TextUtils.ContentData.ContentData(window.btoa('abc'), /* isBase64 */ true, 'application/octet-stream'));
...
//# sourceMappingURL=RequestBinaryResponseView.test.js.map