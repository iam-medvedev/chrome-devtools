...
UI.ViewManager.registerViewExtension({
  ...
  commandPrompt: () => individualThrottlingEnabled() ? i18nString(UIStrings.showRequestConditions) : i18nString(UIStrings.showNetworkRequestBlocking),
  title: () => individualThrottlingEnabled() ? i18nString(UIStrings.networkRequestConditions) : i18nString(UIStrings.networkRequestBlocking),
...
UI.ActionRegistration.registerActionExtension({
  ...
  category: "NETWORK",
  title: () => individualThrottlingEnabled() ? i18nString(UIStrings.addNetworkRequestBlockingOrThrottlingPattern) : i18nString(UIStrings.addNetworkRequestBlockingPattern),
  iconClass: "plus",
  contextTypes() {
...
UI.ActionRegistration.registerActionExtension({
  ...
  category: "NETWORK",
  title: () => individualThrottlingEnabled() ? i18nString(UIStrings.removeAllNetworkRequestBlockingOrThrottlingPatterns) : i18nString(UIStrings.removeAllNetworkRequestBlockingPatterns),
  iconClass: "clear",
  contextTypes() {
    return maybeRetrieveContextTypes((Network) => [Network.RequestConditionsDrawer.RequestConditionsDrawer]);
  },
