...
export class BlockedURLsPane extends UI.Widget.VBox {
    ...
    createEmptyPlaceholder() {
        ...
        const addButton = UI.UIUtils.createTextButton(i18nString(UIStrings.addPattern), this.addPattern.bind(this), 'add-button', true);
        addButton.setAttribute('jslog', `${VisualLogging.action().track({ click: true }).context('network.add-network-request-blocking-pattern')}`);
