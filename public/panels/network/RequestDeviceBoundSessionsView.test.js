            ...
            deviceBoundSessionUsages: [
                {
                    ...
                    usage: "Deferred" /* Protocol.Network.DeviceBoundSessionWithUsageUsage.Deferred */,
                },
                {
                    sessionKey: { site: 'https://example.com', id: 'session-2' },
                    usage: "NotInScope" /* Protocol.Network.DeviceBoundSessionWithUsageUsage.NotInScope */,
                },
                {
                    sessionKey: { site: 'https://example.com', id: 'session-3' },
                    usage: "InScopeRefreshNotYetNeeded" /* Protocol.Network.DeviceBoundSessionWithUsageUsage.InScopeRefreshNotYetNeeded */,
                },
                {
                    sessionKey: { site: 'https://example.com', id: 'session-4' },
                    usage: "InScopeRefreshNotAllowed" /* Protocol.Network.DeviceBoundSessionWithUsageUsage.InScopeRefreshNotAllowed */,
                },
                {
                    sessionKey: { site: 'https://example.com', id: 'session-5' },
                    usage: "ProactiveRefreshNotPossible" /* Protocol.Network.DeviceBoundSessionWithUsageUsage.ProactiveRefreshNotPossible */,
                },
                {
                    sessionKey: { site: 'https://example.com', id: 'session-6' },
                    usage: "ProactiveRefreshAttempted" /* Protocol.Network.DeviceBoundSessionWithUsageUsage.ProactiveRefreshAttempted */,
                },
            ],
        }, {}, container);
...
//# sourceMappingURL=RequestDeviceBoundSessionsView.test.js.map