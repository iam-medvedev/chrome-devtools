...
export class LighthousePanel extends UI.Panel.Panel {
    ...
    renderToolbar() {
        ...
        this.showSettingsPaneSetting = Common.Settings.Settings.instance().createSetting('lighthouseShowSettingsToolbar', false, "Synced" /* Common.Settings.SettingStorageType.Synced */);
