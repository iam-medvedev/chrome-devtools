...
describeWithEnvironment('LighthouseStatusView', () => {
    ...
    beforeEach(() => {
        ...
        const panel = LighthouseModule.LighthousePanel.LighthousePanel.instance({ forceNew: true, protocolService, controller });
        statusView = new LighthouseModule.LighthouseStatusView.StatusView(panel);
        container = document.createElement('div');
        renderElementIntoDOM(container);
    });
    function getHeaderText(statusView) {
...
//# sourceMappingURL=LighthouseStatusView.test.js.map