...
export class AXBreadcrumb {
    ...
    constructor(axNode, depth, inspected) {
        ...
        this.#element.setAttribute('jslog', `${VisualLogging.treeItem().track({ click: true, keydown: 'ArrowUp|ArrowDown|ArrowLeft|ArrowRight|Enter' })}`);
        ...
        if (!this.#axNode.ignored() && this.#axNode.hasOnlyUnloadedChildren()) {
            ...
            VisualLogging.registerLoggable(this.expandLoggable, `${VisualLogging.expand()}`, this.#element, new DOMRect(0, 0, 16, 16));
        }
