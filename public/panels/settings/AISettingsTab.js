...
export class AISettingsTab extends UI.Widget.VBox {
    ...
    #mapSettingDisabledReasons(reasons) {
        ...
        for (const reason of reasons) {
            switch (reason) {
                case "geo-restricted" /* AiAssistanceModel.AiUtils.DisabledReason.GEO_RESTRICTED */:
                    mappedReasons.push(i18nString(UIStrings.geoRestricted));
                    break;
                case "policy-restricted" /* AiAssistanceModel.AiUtils.DisabledReason.POLICY_RESTRICTED */:
                    mappedReasons.push(i18nString(UIStrings.policyRestricted));
                    break;
                case "wrong-locale" /* AiAssistanceModel.AiUtils.DisabledReason.WRONG_LOCALE */:
                    mappedReasons.push(i18nString(UIStrings.wrongLocale));
                    break;
                case "not-supported" /* AiAssistanceModel.AiUtils.DisabledReason.NOT_SUPPORTED */:
                    break;
            }
        }
    ...
    #getDisabledReasons() {
        ...
        for (const precondition of preconditions) {
            switch (precondition) {
                case "is-off-the-record" /* AiAssistanceModel.AiUtils.FrontendAccessPrecondition.IS_OFF_THE_RECORD */:
                ...
                case "no-internet" /* Host.AidaClient.AidaAccessPreconditions.NO_INTERNET */:
                    ...
                    break;
                case "age-restricted" /* AiAssistanceModel.AiUtils.FrontendAccessPrecondition.AGE_RESTRICTED */:
