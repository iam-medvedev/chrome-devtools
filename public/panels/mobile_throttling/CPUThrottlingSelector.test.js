...
describeWithEnvironment('CPUThrottlingSelector view', () => {
    it('renders all CPU throttling options', async () => {
        ...
        MobileThrottling.CPUThrottlingSelector.DEFAULT_VIEW(DEFAULT_INPUT, undefined, element);
    ...
    function testCalibrationItem(throttling, expectedPattern) {
        const element = document.createElement('select');
...
describeWithEnvironment('CPUThrottlingSelector', () => {
    let cpuThrottlingManager;
    async function createWidget(recommendedOption = null) {
        const view = createViewFunctionStub(MobileThrottling.CPUThrottlingSelector.CPUThrottlingSelector);
        const widget = new MobileThrottling.CPUThrottlingSelector.CPUThrottlingSelector(undefined, view);
        widget.markAsRoot();
    ...
    describe('updates CPU throttling manager on change', () => {
        let setOptionSpy;
        beforeEach(() => {
            setOptionSpy = sinon.spy(MobileThrottling.ThrottlingManager.ThrottlingManager.instance(), 'setCPUThrottlingOption');
        });
        it('with preset option', async () => {
            const { view, widget } = await createWidget();
            view.input.onSelect(PanelsCommon.CPUThrottlingOption.MidTierThrottlingOption);
        ...
        it('with calibrated option', async () => {
            const { view, widget } = await createWidget();
            view.input.onSelect(PanelsCommon.CPUThrottlingOption.CalibratedLowTierMobileThrottlingOption);
