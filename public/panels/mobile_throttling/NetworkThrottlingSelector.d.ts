...
export declare class NetworkThrottlingSelector {
    ...
    private options;
    constructor(populateCallback: (arg0: NetworkThrottlingConditionsGroup[]) => Array<SDK.NetworkManager.Conditions | null>, selectCallback: (arg0: number) => void, customNetworkConditionsSetting: Common.Settings.Setting<SDK.NetworkManager.Conditions[]>);
