...
describeWithEnvironment('CombinedDiffView', () => {
    ...
    beforeEach(() => {
        ...
        ({ uiSourceCode } = createFileSystemUISourceCode({ url: URL, content: ORIGINAL_CONTENT, mimeType: 'text/javascript', fileSystemPath: 'file:///workspace' }));
    });
    ...
    describe('file name', () => {
        it('should render workspace relative name with workspace name prefix if the UISourceCode is coming from a workspace', async () => {
