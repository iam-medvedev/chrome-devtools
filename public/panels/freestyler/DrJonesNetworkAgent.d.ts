 ...
 */
export declare class DrJonesNetworkAgent extends AiAgent {
    #private;
    ...
    handleContextDetails(selectedNetworkRequest: SDK.NetworkRequest.NetworkRequest | null): Generator<ThoughtResponse | TitleResponse, void, void>;
