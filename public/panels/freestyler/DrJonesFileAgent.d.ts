...
import { AiAgent, type AidaRequestOptions, type ContextResponse, type ParsedResponse } from './AiAgent.js';
/**
 * One agent instance handles one conversation. Create a new agent
 * instance for a new conversation.
 */
export declare class DrJonesFileAgent extends AiAgent<Workspace.UISourceCode.UISourceCode> {
