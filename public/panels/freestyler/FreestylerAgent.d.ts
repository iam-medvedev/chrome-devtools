...
import { type ActionResponse, AiAgent, type AidaRequestOptions, type ResponseData, type SideEffectResponse, type ThoughtResponse, type TitleResponse } from './AiAgent.js';
 ...
 */
export declare class FreestylerAgent extends AiAgent {
    #private;
    ...
    handleContextDetails(selectedElement: SDK.DOMModel.DOMNode | null): AsyncGenerator<ThoughtResponse | TitleResponse, void, void>;
