...
const UIStringsNotTranslate = {
     ...
     *@description Disclaimer text right after the chat input.
     */
    inputDisclaimerForDrJonesNetworkAgentEnterpriseNoLogging: 'Chat messages and the selected network request are sent to Google. The content you submit and that is generated by this feature will not be used to improve Google’s AI models. This is an experimental AI feature and won’t always get it right.',
    /**
     *@description Disclaimer text right after the chat input.
     */
     ...
     *@description Disclaimer text right after the chat input.
     */
    inputDisclaimerForDrJonesFileAgentEnterpriseNoLogging: 'Chat messages and the selected file are sent to Google. The content you submit and that is generated by this feature will not be used to improve Google’s AI models. This is an experimental AI feature and won’t always get it right.',
    /**
     *@description Disclaimer text right after the chat input.
     */
     ...
     *@description Disclaimer text right after the chat input.
     */
    inputDisclaimerForDrJonesPerformanceAgentEnterpriseNoLogging: 'Chat messages and the selected call stack are sent to Google. The content you submit and that is generated by this feature will not be used to improve Google’s AI models. This is an experimental AI feature and won’t always get it right.',
    /**
...
export class FreestylerChatUi extends HTMLElement {
    ...
    #getDisclaimerText = () => {
        ...
        switch (this.#props.agentType) {
            ...
            case "drjones-file" /* AgentType.DRJONES_FILE */:
                if (noLogging) {
                    return lockedString(UIStringsNotTranslate.inputDisclaimerForDrJonesFileAgentEnterpriseNoLogging);
                }
                return lockedString(UIStringsNotTranslate.inputDisclaimerForDrJonesFileAgent);
            case "drjones-network-request" /* AgentType.DRJONES_NETWORK_REQUEST */:
                if (noLogging) {
                    return lockedString(UIStringsNotTranslate.inputDisclaimerForDrJonesNetworkAgentEnterpriseNoLogging);
                }
                return lockedString(UIStringsNotTranslate.inputDisclaimerForDrJonesNetworkAgent);
            case "drjones-performance" /* AgentType.DRJONES_PERFORMANCE */:
                if (noLogging) {
                    return lockedString(UIStringsNotTranslate.inputDisclaimerForDrJonesPerformanceAgentEnterpriseNoLogging);
                }
