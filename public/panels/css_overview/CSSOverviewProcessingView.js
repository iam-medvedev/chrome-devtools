...
export class CSSOverviewProcessingView extends UI.Widget.Widget {
    ...
    #render() {
        const cancelButton = UI.UIUtils.createTextButton(i18nString(UIStrings.cancel), () => this.#controller.dispatchEventToListeners("RequestOverviewCancel" /* Events.RequestOverviewCancel */), { jslogContext: 'css-overview.cancel-processing', primary: true });
