...
describeWithEnvironment('PlayerMessagesView', () => {
    it('renders messages and errors correctly', async () => {
        ...
        view.addMessage({
            level: "info" /* Protocol.Media.PlayerMessageLevel.Info */,
            message: 'This is an info message',
        });
        view.addMessage({
            level: "warning" /* Protocol.Media.PlayerMessageLevel.Warning */,
            message: 'This is a warning message',
        });
        view.addMessage({
            level: "error" /* Protocol.Media.PlayerMessageLevel.Error */,
            message: 'This is an error message',
        });
        view.addMessage({
            level: "debug" /* Protocol.Media.PlayerMessageLevel.Debug */,
...
//# sourceMappingURL=PlayerMessagesView.test.js.map