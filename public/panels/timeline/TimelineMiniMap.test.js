...
describeWithEnvironment('TimelineMiniMap', function () {
    async function renderMiniMapForScreenshot(parsedTrace) {
        ...
        const zoomedWindow = Trace.Extras.MainThreadActivity.calculateWindow(parsedTrace.data.Meta.traceBounds, mainThread.entries);
