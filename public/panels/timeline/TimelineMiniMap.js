...
export class TimelineMiniMap extends Common.ObjectWrapper.eventMixin(UI.Widget.VBox) {
    ...
    addBreadcrumb({ startTime, endTime }) {
        ...
        TraceBounds.TraceBounds.BoundsManager.instance().setMiniMapBounds(newVisibleTraceWindow);
        TraceBounds.TraceBounds.BoundsManager.instance().setTimelineVisibleWindow(newVisibleTraceWindow);
    ...
    #removeBreadcrumb(breadcrumb) {
        ...
        const newVisibleTraceWindow = TraceEngine.Helpers.Timing.traceWindowFromMilliSeconds(visibleTimesMilli.min, visibleTimesMilli.max);
        TraceBounds.TraceBounds.BoundsManager.instance().setMiniMapBounds(newVisibleTraceWindow);
        TraceBounds.TraceBounds.BoundsManager.instance().setTimelineVisibleWindow(newVisibleTraceWindow);
    }
    wasShown() {
