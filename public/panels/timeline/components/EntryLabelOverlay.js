...
export class EntryLabelOverlay extends HTMLElement {
  ...
  */
    ...
    #drawConnector() {
        ...
        const connectorLineContainer = this.#labelPartsWrapper.querySelector('.connectorContainer');
        const connector = connectorLineContainer.querySelector('line');
        const circle = connectorLineContainer.querySelector('circle');
        const entryHighlightWrapper = this.#labelPartsWrapper.querySelector('.entry-highlight-wrapper');
    ...
    #drawLabel(initialLabel) {
        ...
        this.#labelBox = this.#labelPartsWrapper.querySelector('.label-box');
        if (!this.#labelBox) {
