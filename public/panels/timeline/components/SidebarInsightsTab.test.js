...
describeWithEnvironment('SidebarInsightsTab', () => {
    it('renders a list of insights per navigation in the sidebar', async function () {
        ...
        const navigationURLs = Array.from(component.element.shadowRoot.querySelectorAll('details > summary'))
            .map(elem => elem.title);
        ...
        const navigationURLLabels = Array.from(component.element.shadowRoot.querySelectorAll('details > summary'))
...
//# sourceMappingURL=SidebarInsightsTab.test.js.map