...
export declare function getDocumentLatencyInsight(insights: Trace.Insights.Types.TraceInsightSets | null, navigationId: string | null): Trace.Insights.Types.InsightResults['DocumentLatency'] | null;
