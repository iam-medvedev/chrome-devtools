...
async function renderAnnotationsTab(annotations, annotationEntryToColorMap) {
...
describeWithEnvironment('SidebarAnnotationsTab', () => {
    it('renders annotations list in the sidebar', async function () {
        ...
        const component = await renderAnnotationsTab([entryLabelAnnotation, entryLabelAnnotation2, labelledTimeRangeAnnotation], colorsMap);
        const annotationsWrapperElement = component.contentElement.querySelector('.annotations');
        assert.isNotNull(annotationsWrapperElement);
        const deleteButton = component.contentElement.querySelector('.bin-icon');
    ...
    it('gives the delete button accessible labels', async function () {
        ...
        const deleteButton = component.contentElement.querySelector('.delete-button');
        assert.isNotNull(deleteButton);
    ...
    it('updates annotations list in the sidebar when a new list is passed in', async function () {
        ...
        let annotationLabelElements = component.contentElement.querySelectorAll('.label');
        assert.lengthOf(annotationIdentifierElements, 2);
        ...
        await RenderCoordinator.done();
        await component.updateComplete;
        annotationLabelElements = component.contentElement.querySelectorAll('.label');
