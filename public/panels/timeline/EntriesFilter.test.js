...
describeWithEnvironment('EntriesFilter', function () {
    ...
    it('adds the collapsed entry into the expandableEntries array', async function () {
        ...
        stack.applyFilterAction({ type: "COLLAPSE_FUNCTION" /* PerfUI.FlameChart.FilterAction.COLLAPSE_FUNCTION */, entry: entryTwo });
    ...
    it('adds the next visible parent of the merged entry into the expandableEntries array if the direct parent is hidden', async function () {
        ...
        stack.applyFilterAction({ type: "MERGE_FUNCTION" /* PerfUI.FlameChart.FilterAction.MERGE_FUNCTION */, entry: foo2Calls[1] });
    ...
    it('supports collapsing all repeating entries among descendants', async function () {
        ...
        stack.applyFilterAction({ type: "COLLAPSE_REPEATING_DESCENDANTS" /* PerfUI.FlameChart.FilterAction.COLLAPSE_REPEATING_DESCENDANTS */, entry: firstFooCallEntry });
    ...
    it('supports undo all filter actions by applying context menu undo action', async function () {
        ...
        stack.applyFilterAction({ type: "COLLAPSE_REPEATING_DESCENDANTS" /* PerfUI.FlameChart.FilterAction.COLLAPSE_REPEATING_DESCENDANTS */, entry: fibonacciCalls[0] });
        // We collapsed identical descendants after the first `foo` entry - so it should not be included in the invisible list itself,
        // but all foo() calls below it in the stack should now be invisible.
        ...
        stack.applyFilterAction({ type: "MERGE_FUNCTION" /* PerfUI.FlameChart.FilterAction.MERGE_FUNCTION */, entry: basicStackOne });
