...
async function waitForWidgetSizeToUpdate(flameChartView) {
...
describe('TimelineFlameChartView', function () {
    ...
    it('fires an event when an entry label overlay is clicked', async function () {
        ...
        flameChartView.addEventListener("EntryLabelAnnotationClicked" /* Timeline.TimelineFlameChartView.Events.ENTRY_LABEL_ANNOTATION_CLICKED */, event => {
