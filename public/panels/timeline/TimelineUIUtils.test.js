...
describeWithEnvironment('TimelineUIUtils', function () {
    ...
    describe('mapping to authored script when recording is fresh', function () {
        beforeEach(async () => {
            ...
            const script = debuggerModel.parsedScriptSource(SCRIPT_ID_STRING, scriptUrl, 0, 0, 0, 0, 0, '', undefined, sourceMapUrl, true, false, length, false, null, null, null, null, null, null);
