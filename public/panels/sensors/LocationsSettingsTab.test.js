...
async function setupLocationDialog(input, target) {
...
describeWithEnvironment('renderLocationDialog', () => {
    ...
    it('renders in add mode with empty location inputs', async () => {
        ...
        const titleInput = getDialogContent().querySelector('input[placeholder="Location name"]');
    ...
    it('renders in edit mode with existing location data', async () => {
        ...
        const latInput = getDialogContent().querySelector('input[placeholder="Latitude"]');
    ...
    it('calls onValidateErrors when saving invalid input without calling onSave', async () => {
        ...
        const saveButton = getDialogContent().querySelector('.save-button');
...
describeWithEnvironment('renderLocationDialog screenshots', () => {
    ...
    async function setupAndRenderDialog(input) {
