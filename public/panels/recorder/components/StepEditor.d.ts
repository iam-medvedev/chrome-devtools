...
import { type Assignments, type DeepImmutable, type DeepPartial, type Keys } from './util.js';
...
export declare function renderStepEditor(input: ViewInput): Lit.TemplateResult;
export {};
