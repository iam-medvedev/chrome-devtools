...
var StepEditor = class extends UI6.Widget.Widget {
  #state;
  #error;
  #isTypeEditable = true;
  #disabled = false;
  ...
  performUpdate() {
    ...
    render7(renderStepEditor(input), this.contentElement, { container: { listeners: { keydown: this.#handleKeyDownEvent } } });
  }
  #commit(updatedState) {
    try {
...
function renderStepEditor(input) {
