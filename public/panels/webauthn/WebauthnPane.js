...
export class WebauthnPaneImpl extends UI.Widget.VBox {
    ...
    #createNewAuthenticatorSection() {
        ...
        const residentKeyCheckboxLabel = UI.UIUtils.createLabel(i18nString(UIStrings.supportsResidentKeys), 'authenticator-option-label');
        ...
        const userVerificationCheckboxLabel = UI.UIUtils.createLabel(i18nString(UIStrings.supportsUserVerification), 'authenticator-option-label');
        userVerificationCheckboxLabel.setAttribute('jslog', `${VisualLogging.toggle('user-verification').track({ change: true })}`);
        ...
        const largeBlobCheckboxLabel = UI.UIUtils.createLabel(i18nString(UIStrings.supportsLargeBlob), 'authenticator-option-label');
