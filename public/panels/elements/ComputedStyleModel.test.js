...
describeWithMockConnection('ComputedStyleModel', () => {
    ...
    let trackComputedStyleUpdatesForNodeSpy;
    async function waitForTrackComputedStyleUpdatesForNodeCall() {
    ...
    it('should track computed style updates when computed widget is shown', async () => {
        ...
        UI.Context.Context.instance().setFlavor(Elements.ComputedStyleWidget.ComputedStyleWidget, sinon.createStubInstance(Elements.ComputedStyleWidget.ComputedStyleWidget));
        await waitForTrackComputedStyleUpdatesForNodeCall();
    ...
    it('should track computed style updates when the node is changed', async () => {
        ...
        UI.Context.Context.instance().setFlavor(SDK.DOMModel.DOMNode, createNode(target, { nodeId: 2 }));
        await waitForTrackComputedStyleUpdatesForNodeCall();
