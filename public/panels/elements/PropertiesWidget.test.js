...
describeWithMockConnection('PropertiesWidget', () => {
    ...
    it('invokes a getter when clicking on the invoke button', async () => {
        ...
        const nodes = Array.from(ObjectUI.ObjectPropertiesSection.ObjectPropertyTreeElement.createPropertyNodes(objectTree.children || { properties: [], internalProperties: [], accessors: [] }, true, true));
        ...
        const accessorNode = nodes.find(n => n instanceof ObjectUI.ObjectPropertiesSection.ObjectPropertyTreeElement && n.property?.name === 'myGetter');
