...
describeWithMockConnection('LayoutPane', () => {
    ...
    it('renders settings', async () => {
        ...
        assert.deepEqual(queryLabels(component.contentElement, '[data-boolean-setting]'), [{ label: 'Boolean setting title', input: 'INPUT' }, { label: '', input: 'INPUT' }, { label: '', input: 'INPUT' }]);
    });
