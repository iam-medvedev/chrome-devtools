...
describeWithEnvironment('CSSPropertyDocsView', () => {
    it('renders every section', async () => {
        const cssProperty = {
            ...
            baseline: {
                status: "high" /* ElementsComponents.CSSPropertyDocsView.BaselineStatus.HIGH */,
    ...
    it('renders correct baseline text for various scenarios', () => {
        const testCases = [
            {
                ...
                cssProperty: {
                    name: 'property1',
                    baseline: { status: "false" /* ElementsComponents.CSSPropertyDocsView.BaselineStatus.LIMITED */ },
                    // Assuming 'E' (Edge) and 'S' (Safari macOS) are known and FF, C are missing
                    browsers: ['E12', 'S1'],
                },
                expectedText: 'Limited availability across major browsers (not fully implemented in Chrome, Firefox, or Safari on iOS)',
            },
            {
            ...
            },
            {
                ...
                cssProperty: {
                    name: 'property4',
                    baseline: { status: "low" /* ElementsComponents.CSSPropertyDocsView.BaselineStatus.LOW */, baseline_low_date: '2023-01-15' },
                },
            ...
            },
            {
                ...
                cssProperty: {
                    name: 'property5',
                    baseline: { status: "high" /* ElementsComponents.CSSPropertyDocsView.BaselineStatus.HIGH */, baseline_high_date: '2020-05-10' },
                },
            ...
            },
            {
                ...
                cssProperty: {
                    name: 'property6',
                    baseline: { status: "low" /* ElementsComponents.CSSPropertyDocsView.BaselineStatus.LOW */ },
                },
        ...
        for (const testCase of testCases) {
            ...
            assert.include(actualText || '', testCase.expectedText, `${testCase.description}: baseline text did not contain expected text`);
        }
    });
});
