...
describeWithEnvironment('ElementsTreeOutline', () => {
    ...
    it('should include the ::interest-button pseudo element', () => {
        const buttonNode = SDK.DOMModel.DOMNode.create(model, null, false, {
            ...
            pseudoElements: [{
                    ...
                    backendNodeId: 2,
                    nodeType: Node.ELEMENT_NODE,
                    pseudoType: "interest-button" /* Protocol.DOM.PseudoType.InterestButton */,
    ...
    describe('Snapshot mode', () => {
        ...
        it('auto-expands the root node in snapshot mode', async () => {
            ...
            const rootTreeElement = snapshotTreeOutline.rootElement().childAt(0);
        ...
        it('limits depth to root + 1 level in snapshot mode', async () => {
            ...
            const childTreeElement = rootTreeElement.childAt(0);
        ...
        it('allows ShadowRoot to exceed depth limit', async () => {
            ...
            await snapshotTreeOutline.populateTreeElement(rootTreeElement);
            const shadowRootTreeElement = rootTreeElement.childAt(0);
            ...
            const childTreeElement = shadowRootTreeElement.childAt(0);
            assert.isNotNull(childTreeElement);
        ...
        it('limits the total number of rows and shows a "Show all" button', async () => {
            ...
            const container = shadowRoot.querySelector('.elements-disclosure');
            ...
            const showAllButton = shadowRoot.querySelector('.elements-tree-show-all');
            ...
            assert.isFalse(container.classList.contains('elements-tree-truncated'), 'Container should not have truncated class after click');
        });
    });
