...
export class LinkableNameRenderer extends rendererBase(SDK.CSSPropertyParserMatchers.LinkableNameMatch) {
    ...
    #getLinkData(match) {
        switch (match.propertyName) {
            ...
            case "function" /* SDK.CSSPropertyParserMatchers.LinkableNameProperties.FUNCTION */:
                return {
    ...
    render(match) {
        ...
        swatch.data = {
            ...
            onLinkActivate: () => {
                ...
                if (match.propertyName === "function" /* SDK.CSSPropertyParserMatchers.LinkableNameProperties.FUNCTION */) {
...
export class StylePropertyTreeElement extends UI.TreeOutline.TreeElement {
    ...
    getTooltipId(key) {
        ...
        const propertyCount = this.treeOutline?.rootElement().children().reduce((value, element, index) => index < ownIndex && element instanceof StylePropertyTreeElement &&
