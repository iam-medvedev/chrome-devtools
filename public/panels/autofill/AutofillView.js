...
const DEFAULT_VIEW = (input, _output, target) => {
    const renderAddress = () => {
        ...
        const spans = [];
        const matchIndices = new Set([0, input.address.length]);
...
export class AutofillView extends UI.Widget.VBox {
    ...
    #matches = [];
    #highlightedMatches = [];
    constructor(autofillManager, view = DEFAULT_VIEW) {
    ...
    wasShown() {
        ...
        this.#autofillManager.addEventListener("AddressFormFilled" /* AutofillManager.AutofillManager.Events.ADDRESS_FORM_FILLED */, this.#onAddressFormFilled, this);
    ...
    willHide() {
        ...
        this.#autofillManager.removeEventListener("AddressFormFilled" /* AutofillManager.AutofillManager.Events.ADDRESS_FORM_FILLED */, this.#onAddressFormFilled, this);
        super.willHide();
    }
