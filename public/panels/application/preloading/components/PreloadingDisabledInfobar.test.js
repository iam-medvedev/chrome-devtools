    ...
    it('renders disabled by preference', async () => {
        ...
        assert.deepEqual(input, {
            ...
            warnings: [{
                    ...
                    valueId: 'Speculative loading is disabled because of user settings or an extension. Go to {PH1} to update your preference. Go to {PH2} to disable any extension that blocks speculative loading.',
                    placeholders: {
                        PH1: {
    ...
    it('renders force enabled by prefetch holdback', async () => {
        ...
        assert.deepEqual(input, {
            ...
            warnings: [{
                    ...
                    valueId: 'Prefetch is forced-enabled because DevTools is open. When DevTools is closed, prefetch will be disabled because this browser session is part of a holdback group used for performance comparisons.',
                }],
        });
    });
    it('renders force enabled by prerender holdback', async () => {
        ...
        assert.deepEqual(input, {
            ...
            warnings: [{
                    ...
                    valueId: 'Prerendering is forced-enabled because DevTools is open. When DevTools is closed, prerendering will be disabled because this browser session is part of a holdback group used for performance comparisons.',
                }],
        });
    });
...
//# sourceMappingURL=PreloadingDisabledInfobar.test.js.map