...
describeWithMockConnection('DeviceBoundSessionsTreeElement', () => {
    ...
    it('builds the correct tree hierarchy on INITIALIZE_SESSIONS event only for visible sites', () => {
        ...
        model.dispatchEventToListeners("INITIALIZE_SESSIONS" /* Application.DeviceBoundSessionsModel.DeviceBoundSessionModelEvents.INITIALIZE_SESSIONS */, { sessions });
        // Verify site nodes.
    ...
    it('removes empty tree elements on CLEAR_EVENTS', () => {
        ...
        model.addVisibleSite('example1.com');
        model.addVisibleSite('example2.com');
        model.dispatchEventToListeners("EVENT_OCCURRED" /* Application.DeviceBoundSessionsModel.DeviceBoundSessionModelEvents.EVENT_OCCURRED */, { site: 'example1.com', sessionId: undefined });
        model.dispatchEventToListeners("EVENT_OCCURRED" /* Application.DeviceBoundSessionsModel.DeviceBoundSessionModelEvents.EVENT_OCCURRED */, { site: 'example1.com', sessionId: 'session_1' });
        model.dispatchEventToListeners("EVENT_OCCURRED" /* Application.DeviceBoundSessionsModel.DeviceBoundSessionModelEvents.EVENT_OCCURRED */, { site: 'example1.com', sessionId: 'session_2' });
        model.dispatchEventToListeners("EVENT_OCCURRED" /* Application.DeviceBoundSessionsModel.DeviceBoundSessionModelEvents.EVENT_OCCURRED */, { site: 'example2.com', sessionId: 'session_1' });
        model.dispatchEventToListeners("EVENT_OCCURRED" /* Application.DeviceBoundSessionsModel.DeviceBoundSessionModelEvents.EVENT_OCCURRED */, { site: 'hidden.com', sessionId: 'session_1' });
        assert.strictEqual(root.childCount(), 2);
        const siteNode1 = root.children()[0];
        const siteNode2 = root.children()[1];
        assert.strictEqual(siteNode1.title, 'example1.com');
    ...
    it('removes a tree element if visible sites are cleared', () => {
        ...
        model.dispatchEventToListeners("INITIALIZE_SESSIONS" /* Application.DeviceBoundSessionsModel.DeviceBoundSessionModelEvents.INITIALIZE_SESSIONS */, { sessions: [session] });
        assert.strictEqual(root.childCount(), 1);
    ...
    it('shows the default view when a site tree element is selected', () => {
        ...
        sinon.assert.calledWith(showDefaultSpy, model, 'Device bound sessions', 'On this page you can view device bound sessions and associated events');
    });
    ...
    it('adds a tree element when EVENT_OCCURRED fires for a new session', () => {
        ...
        model.dispatchEventToListeners("EVENT_OCCURRED" /* Application.DeviceBoundSessionsModel.DeviceBoundSessionModelEvents.EVENT_OCCURRED */, { site: 'example1.com' });
        assert.strictEqual(root.childCount(), 1);
