...
describeWithMockConnection('DeviceBoundSessionsModel', () => {
    ...
    let target;
    let networkManager;
    function makeSession(site, sessionId) {
        return {
    ...
    it('stores sessions and dispatches INITIALIZE_SESSIONS event when onSessionsSet is called', () => {
        ...
        model.addEventListener("INITIALIZE_SESSIONS" /* Application.DeviceBoundSessionsModel.DeviceBoundSessionModelEvents.INITIALIZE_SESSIONS */, listener);
    ...
    it('adds visible sites and dispatches ADD_VISIBLE_SITE event', () => {
        const listener = sinon.spy();
        model.addEventListener("ADD_VISIBLE_SITE" /* Application.DeviceBoundSessionsModel.DeviceBoundSessionModelEvents.ADD_VISIBLE_SITE */, listener);
    ...
    it('clears visible sites and dispatches CLEAR_VISIBLE_SITES event if preserving log', () => {
        ...
        assert.isTrue(model.isSiteVisible('example.com'));
        const listener = sinon.spy();
        model.addEventListener("CLEAR_VISIBLE_SITES" /* Application.DeviceBoundSessionsModel.DeviceBoundSessionModelEvents.CLEAR_VISIBLE_SITES */, listener);
    ...
    it('clears events and dispatches CLEAR_EVENTS event if preserving log', () => {
        ...
        const event1 = {
            ...
            site,
            succeeded: false,
            creationEventDetails: { fetchResult: "InvalidConfigJson" /* Protocol.Network.DeviceBoundSessionFetchResult.InvalidConfigJson */ }
        };
        const event2 = {
            eventId: 'event_2',
            sessionId: 'sessionId',
        ...
        const listener = sinon.spy();
        model.addEventListener("CLEAR_EVENTS" /* Application.DeviceBoundSessionsModel.DeviceBoundSessionModelEvents.CLEAR_EVENTS */, listener);
    ...
    it('handles storing events and subsequent EVENT_OCCURRED dispatches', () => {
        ...
        const listener = sinon.spy();
        model.addEventListener("EVENT_OCCURRED" /* Application.DeviceBoundSessionsModel.DeviceBoundSessionModelEvents.EVENT_OCCURRED */, listener);
        // Trigger event 1.
        ...
        const event1 = {
            ...
            succeeded: true,
            creationEventDetails: { newSession: creationSession, fetchResult: "Success" /* Protocol.Network.DeviceBoundSessionFetchResult.Success */ }
        };
        networkManager.dispatchEventToListeners(SDK.NetworkManager.Events.DeviceBoundSessionEventOccurred, event1);
        ...
        const event3 = {
            ...
            succeeded: true,
            creationEventDetails: { fetchResult: "Success" /* Protocol.Network.DeviceBoundSessionFetchResult.Success */, newSession: session2 }
        };
        networkManager.dispatchEventToListeners(SDK.NetworkManager.Events.DeviceBoundSessionEventOccurred, event3);
        ...
        const event4 = {
            ...
            sessionId: sessionId2,
            succeeded: true,
            challengeEventDetails: { challenge: challengeString, challengeResult: "Success" /* Protocol.Network.ChallengeEventDetailsChallengeResult.Success */ }
        };
        networkManager.dispatchEventToListeners(SDK.NetworkManager.Events.DeviceBoundSessionEventOccurred, event4);
    ...
    it('updates isSessionTerminated status correctly on termination and recreation', () => {
        ...
        networkManager.dispatchEventToListeners(SDK.NetworkManager.Events.DeviceBoundSessionEventOccurred, terminationEvent);
        ...
        networkManager.dispatchEventToListeners(SDK.NetworkManager.Events.DeviceBoundSessionEventOccurred, failedRecreateEvent);
        assert.isTrue(model.isSessionTerminated(site, sessionId));
        assert.isTrue(session?.isSessionTerminated);
...
//# sourceMappingURL=DeviceBoundSessionsModel.test.js.map