...
describe('CookieItemsView', () => {
    ...
    beforeEach(() => {
        ...
        cookieItemsView = new Application.CookieItemsView.CookieItemsView(mockCookieModel, 'example.com', viewFunction);
    });
    ...
    it('sets StorageItem flavor on select', () => {
        ...
        assert.strictEqual(flavor.name, 'cookie-name');
        assert.strictEqual(flavor.origin, 'example.com');
    });
});
//# sourceMappingURL=CookieItemsView.test.js.map