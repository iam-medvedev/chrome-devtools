    ...
    describe('link/image stripping', () => {
        ...
        it('strips images', () => {
            ...
            for (const imageCase of imageCases) {
                ...
                assert.isFalse(['<a', '<devtools-link', '<img', '<devtools-markdown-image'].some(tagName => elem.outerHTML.includes(tagName)));
            }
        });
    });
});
//# sourceMappingURL=MarkdownRendererWithCodeBlock.test.js.map