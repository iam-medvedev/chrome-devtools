...
export function formatInitiatorUrl(initiatorUrl, allowedOrigin) {
...
function formatRequestInitiated(request, initiatorChain, lineStart, allowedOrigin) {
 ...
 */
export function formatRequestInitiatorChain(request) {
