...
:host {
  ...
  --override-color-perf-monitor-cpu: var(--ref-palette-yellow40);
  ...
  --override-color-perf-monitor-layout-count: var(--ref-palette-pink50);
...
:host-context(.theme-with-dark-background) {
  ...
  --override-color-perf-monitor-js-event-listeners: var(--ref-palette-green70);
