...
export declare class CPUFlameChartDataProvider extends ProfileFlameChartDataProvider {
    ...
    constructor(cpuProfile: CPUProfile.CPUProfileDataModel.CPUProfileDataModel, cpuProfilerModel: SDK.CPUProfilerModel.CPUProfilerModel | null);
...
export declare namespace CPUFlameChartDataProvider {
    class ChartEntry {
        ...
        constructor(depth: number, duration: number, startTime: number, selfTime: number, node: CPUProfile.ProfileTreeModel.ProfileNode);
    }
}
