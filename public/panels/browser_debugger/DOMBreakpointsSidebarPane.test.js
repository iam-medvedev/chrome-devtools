...
describe('DOMBreakpointsSidebarPane', () => {
    ...
    it('renders correctly with some breakpoints', async () => {
        ...
        const breakpoint1 = {
            node: node1,
            type: "subtree-modified" /* Protocol.DOMDebugger.DOMBreakpointType.SubtreeModified */,
            enabled: true,
            domDebuggerModel: {
                toggleDOMBreakpoint: () => { },
            },
        ...
        const breakpoint2 = {
            node: node2,
            type: "attribute-modified" /* Protocol.DOMDebugger.DOMBreakpointType.AttributeModified */,
            enabled: false,
            domDebuggerModel: {
                toggleDOMBreakpoint: () => { },
            },
...
describe('DOMBreakpointsSidebarPane', () => {
    ...
    setupLocaleHooks();
    let target;
    let domDebuggerModel;
    beforeEach(() => {
        target = createTarget();
        domDebuggerModel = target.model(SDK.DOMDebuggerModel.DOMDebuggerModel);
    });
    it('calls toggleDOMBreakpoint when onBreakpointCheckboxClick is called', async () => {
        ...
        const breakpoint = new SDK.DOMDebuggerModel.DOMBreakpoint(domDebuggerModel, node, "subtree-modified" /* Protocol.DOMDebugger.DOMBreakpointType.SubtreeModified */, true);
    ...
    it('calls removeDOMBreakpoint when remove option is selected from context menu', async () => {
        ...
        removeCallback();
        sinon.assert.calledWith(removeStub, node, "subtree-modified" /* Protocol.DOMDebugger.DOMBreakpointType.SubtreeModified */);
...
//# sourceMappingURL=DOMBreakpointsSidebarPane.test.js.map