...
describe('ModificationsManager', () => {
    it('correctly generates an entry hash', async function () {
        ...
        const modificationsManager = ModificationsManager.ModificationsManager.ModificationsManager.maybeInstance({ entryToNodeMap: data.Renderer.entryToNode, wholeTraceBounds: boundsManager.state()?.micro.entireTraceBounds });
