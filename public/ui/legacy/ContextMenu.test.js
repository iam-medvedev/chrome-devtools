...
describeWithEnvironment('ContextMenu', () => {
    ...
    it('logs impressions and clicks for hosted menu', async () => {
        ...
        assert.sameDeepMembers(stabilizeImpressions(recordImpression.firstCall.firstArg.impressions), [{ id: 0, type: 67 }, { id: 1, type: 29, parent: 0, context: 42 }, { id: 2, type: 29, parent: 0, context: 44 }]);
        ...
        assert.deepStrictEqual(stabilizeEvent(recordClick.firstCall.firstArg), { veid: 0, mouseButton: 0, doubleClick: false, context: 44 });
