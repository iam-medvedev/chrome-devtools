...
describeWithEnvironment('ContextMenu', () => {
    ...
    it('records new badge usage', async () => {
        ...
        await contextMenu.show();
        const newBadgeUsageStub = sinon.stub(Host.InspectorFrontendHost.InspectorFrontendHostInstance, 'recordNewBadgeUsage');
        Host.InspectorFrontendHost.InspectorFrontendHostInstance.events.dispatchEventToListeners(Host.InspectorFrontendHostAPI.Events.ContextMenuItemSelected, item.id());
