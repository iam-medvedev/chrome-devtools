...
export declare const bindToSetting: (setting: string | Common.Settings.Setting<boolean | string>, stringValidator?: (newSettingValue: string) => boolean) => ReturnType<typeof Directives.ref>;
/**
