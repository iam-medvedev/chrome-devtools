...
describe('bindToSetting (string)', () => {
    function setup(validate) {
        ...
        const inputRef = Directives.createRef();
...
describe('bindToSetting (boolean)', () => {
    function setup() {
        ...
        renderElementIntoDOM(container);
        const inputRef = Directives.createRef();
        render(html `<devtools-checkbox ${Directives.ref(inputRef)} ${bindToSetting(setting)}></devtools-checkbox>`, container);
        const input = inputRef.value;
        assert.exists(input);
        return { input, setting, container };
    }
...
//# sourceMappingURL=SettingsUI.test.js.map