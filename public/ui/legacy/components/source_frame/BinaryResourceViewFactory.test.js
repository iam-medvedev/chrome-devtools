...
describeWithEnvironment('BinaryResourceViewFactory', () => {
    it('interprets base64 content correctly', async () => {
        ...
        const factory = new SourceFrame.BinaryResourceViewFactory.BinaryResourceViewFactory(base64content, 'http://example.com', Common.ResourceType.resourceTypes.WebSocket);
        ...
        assert.strictEqual(await getResourceText(factory.createHexView()), `00000000: 7365 6e64 696e 6720 7468 6973 2075 7466  sending this utf
