...
describeWithMockConnection('LineLevelProfile', () => {
    ...
    describe('Helper', () => {
        it('should collect and apply performance decorations', async () => {
            const helper = new PerfUI.LineLevelProfile.Helper("performance" /* Workspace.UISourceCode.DecoratorType.PERFORMANCE */);
            ...
            sinon.stub(debuggerModel, 'createRawLocationByURL')
                .returns(new SDK.DebuggerModel.Location(debuggerModel, 'scriptId', 4, 9));
...
//# sourceMappingURL=LineLevelProfile.test.js.map