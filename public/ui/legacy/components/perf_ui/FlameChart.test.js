...
describeWithEnvironment('FlameChart', () => {
                ...
                return PerfUI.FlameChart.FlameChartTimelineData.create({
                    ...
                    groups: [
                        ...
                        },
                        {
                            name: 'Test Group 2',
                            startLevel: 2,
                            style: { ...defaultGroupStyle, collapsible: 0 /* PerfUI.FlameChart.GroupCollapsibleState.ALWAYS */, nestingLevel: 1 },
                        },
                        {
                            name: 'Test Group 3',
                            startLevel: 3,
                            style: { ...defaultGroupStyle, collapsible: 0 /* PerfUI.FlameChart.GroupCollapsibleState.ALWAYS */, nestingLevel: 2 },
                        },
                        {
                            name: 'Test Group 4',
                            startLevel: 4,
                        ...
                        },
                        {
                            name: 'Test Group 5',
                            startLevel: 5,
                            style: { ...defaultGroupStyle, collapsible: 0 /* PerfUI.FlameChart.GroupCollapsibleState.ALWAYS */, nestingLevel: 0 },
                        },
                    ],
                });
            }
    ...
    it.skip('[crbug.com/474034100]: renders correctly with a vertical offset', async function () {
        ...
        const event = allThreadEntriesInTrace(parsedTrace).find(entry => {
            return entry.dur === 462 && entry.ts === 1020035043753 && entry.name === "UpdateLayoutTree" /* Trace.Types.Events.Name.RECALC_STYLE */;
        });
        assert.isOk(event);
