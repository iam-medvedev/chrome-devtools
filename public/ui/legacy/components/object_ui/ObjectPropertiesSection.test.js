...
describeWithEnvironment('ObjectPropertyTreeElement', () => {
    it('can edit values', async () => {
        ...
        const section = new ObjectUI.ObjectPropertiesSection.ObjectPropertyTreeElement(new ObjectUI.ObjectPropertiesSection.ObjectTreeNode(property));
        section.treeOutline = new ObjectUI.ObjectPropertiesSection.ObjectPropertiesSectionsTreeOutline();
        const promptStub = sinon.stub(ObjectUI.ObjectPropertiesSection.ObjectPropertyPrompt.prototype, 'attachAndStartEditing');
