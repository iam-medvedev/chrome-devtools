...
var DataGridElement = class extends HTMLElement {
  ...
  constructor() {
    ...
    this.#dataGrid.addEventListener("SelectedNode", (e) => this.dispatchEvent(new CustomEvent("select", { detail: e.data.configElement })));
    this.#dataGrid.addEventListener("DeselectedNode", () => this.dispatchEvent(new CustomEvent("select", { detail: null })));
  ...
  #addNodes(nodes) {
    for (const element of this.#getDataRows(nodes)) {
      const parentNode = this.#dataGrid.rootNode();
