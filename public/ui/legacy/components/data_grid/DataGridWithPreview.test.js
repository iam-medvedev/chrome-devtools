...
describeWithEnvironment('DataGridWithPreview', () => {
    ...
    const createPreviewFunc = sinon.stub();
    const expectCreatePreviewCalled = async (expectedKey, expectedValue) => {
    ...
    beforeEach(() => {
        ...
        container.show(div);
        dataGridWithPreview = new DataGrid.DataGridWithPreview.DataGridWithPreview('', container.element, COLUMNS, {
            refreshItems: () => { },
            edit: {
                removeItem: () => { },
                setItem: () => { },
...
//# sourceMappingURL=DataGridWithPreview.test.js.map