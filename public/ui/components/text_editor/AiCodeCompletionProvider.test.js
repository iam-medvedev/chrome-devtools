...
describeWithEnvironment('AiCodeCompletionProvider', () => {
    ...
    describe('Teaser decoration', () => {
        ...
        it('hides teaser when mode is OFF', async () => {
            ...
            assert.isNotNull(editor.editor.dom.querySelector('.cm-placeholder'));
            editor.dispatch({
                effects: AiCodeCompletionProvider.setAiCodeCompletionTeaserMode.of(AiCodeCompletionProvider.AiCodeCompletionTeaserMode.OFF),
            });
            await clock.tickAsync(0);
        ...
        it('shows teaser when mode is ONLY_SHOW_ON_EMPTY and editor is empty', async () => {
            const { editor, provider } = createEditorWithProvider('');
            editor.dispatch({
                effects: AiCodeCompletionProvider.setAiCodeCompletionTeaserMode.of(AiCodeCompletionProvider.AiCodeCompletionTeaserMode.ONLY_SHOW_ON_EMPTY),
            });
            await clock.tickAsync(0);
            assert.isNotNull(editor.editor.dom.querySelector('.cm-placeholder'));
            provider.dispose();
...
//# sourceMappingURL=AiCodeCompletionProvider.test.js.map