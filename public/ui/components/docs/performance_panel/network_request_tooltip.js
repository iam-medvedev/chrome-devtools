...
async function renderTooltips2() {
    ...
    const traceParsedData = await TraceLoader.TraceLoader.traceEngine(/* mocha context */ null, 'render-blocking-in-iframe.json.gz');
...
async function renderTooltips3() {
    ...
    const traceParsedData = await TraceLoader.TraceLoader.traceEngine(/* mocha context */ null, 'changing-priority.json.gz');
