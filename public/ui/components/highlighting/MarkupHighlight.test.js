...
describe('MarkupHighlight', () => {
    ...
    function performTest(innerHTML, ranges, expectedHighlighted) {
    ...
    it('highlights all text in 3 text nodes', () => {
        performTest(['<span>function</span>', '<span> </span>', '<span>functionName</span>'], [range(0, 21)], ['<span><span class="highlighted">function functionName</span></span>', '<span></span>', '<span></span>']);
    });
    it('highlights all text in 3 text nodes except for the last character', () => {
        performTest(['<span>function</span>', '<span> </span>', '<span>functionName</span>'], [range(0, 20)], ['<span><span class="highlighted">function functionNam</span></span>', '<span></span>', '<span>e</span>']);
    });
    it('highlights all text in 3 text nodes except for the first character', () => {
        performTest(['<span>function</span>', '<span> </span>', '<span>functionName</span>'], [range(1, 20)], ['<span>f<span class="highlighted">unction functionName</span></span>', '<span></span>', '<span></span>']);
    });
    it('highlights all text in 3 text nodes except for the first and the last characters', () => {
        performTest(['<span>function</span>', '<span> </span>', '<span>functionName</span>'], [range(1, 19)], ['<span>f<span class="highlighted">unction functionNam</span></span>', '<span></span>', '<span>e</span>']);
    });
    it('highlights across nodes', () => {
        performTest(['<span>function</span>', '<span> </span>', '<span>functionName</span>'], [range(7, 3)], ['<span>functio<span class="highlighted">n f</span></span>', '<span></span>', '<span>unctionName</span>']);
    });
...
//# sourceMappingURL=MarkupHighlight.test.js.map