 ...
 */
export function extractVeName(vePath) {
 ...
 */
export function matchesVePath(element, vePath, targetVeName = extractVeName(vePath)) {
 ...
 */
export function getSiblingIndex(element, vePath, root = element.ownerDocument || document) {
 ...
 */
export function deepQuerySelectorAll(root, selector, limit = Infinity) {
    const results = [];
 ...
 */
export function rematchCommentAnchor(comment, root = document, cachedJslogElements) {
