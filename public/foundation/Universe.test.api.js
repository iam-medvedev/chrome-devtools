...
describe('Universe API Test', () => {
    describe('ConsoleModel', () => {
        it('receives console messages emitted from inspected page in universe ConsoleModel', async ({ inspectedPage, universe }) => {
            ...
            assert.strictEqual(consoleMessage?.messageText, 'Hello from Universe API Test!', 'Console message should be received by universe ConsoleModel');
        });
    });
...
//# sourceMappingURL=Universe.test.api.js.map