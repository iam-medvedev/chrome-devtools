...
var Pe = 0.8999999999999999;
var Re = 0.5;
var He = 0.49999999999999994;
function Ne(o5) {
  let e = Math.sign(o5);
  o5 = Math.abs(o5);
...
function fe({ median: o5, p10: e }, t) {
  ...
  if (t <= 0) return 1;
  let n = 0.9061938024368232, r = Math.max(Number.MIN_VALUE, t / o5), i = Math.log(r), a = Math.max(Number.MIN_VALUE, e / o5), l = -Math.log(a), s = i * n / l, c = (1 - Ne(s)) / 2, d;
  return t <= e ? d = Math.max(0.9, Math.min(1, c)) : t <= o5 ? d = Math.max(Re, Math.min(Pe, c)) : d = Math.max(0, Math.min(He, c)), d;
}
var O = "\u2026";
var Oe = "\xA0";
var ve = 0.9;
var Ve = { PASS: { label: "pass", minScore: ve }, AVERAGE: { label: "average", minScore: 0.5 }, FAIL: { label: "fail" }, ERROR: { label: "error" } };
var $e = ["com", "co", "gov", "edu", "ac", "org", "go", "gob", "or", "net", "in", "ne", "nic", "gouv", "web", "spb", "blog", "jus", "kiev", "mil", "wi", "qc", "ca", "bel", "on"];
var E = class o {
  static get RATINGS() {
    return Ve;
  }
  ...
  static getMainDocumentUrl(e) {
    return e.mainDocumentUrl || e.finalUrl;
  }
  static getFullPageScreenshot(e) {
  ...
  static truncate(e, t, n = "\u2026") {
    if (e.length <= t) return e;
    let i = new Intl.Segmenter(void 0, { granularity: "grapheme" }).segment(e)[Symbol.iterator](), a = 0;
    for (let l = 0; l <= t - n.length; l++) {
      let s = i.next();
      if (s.done) return e;
      a = s.value.index;
    }
    for (let l = 0; l < n.length; l++) if (i.next().done) return e;
  ...
  static getChromeExtensionOrigin(e) {
    let t = new URL(e);
  ...
  static getPseudoTld(e) {
    ...
    return $e.includes(t[0]) ? `.${t.join(".")}` : `.${t[t.length - 1]}`;
  }
  ...
  static computeLogNormalScore(e, t) {
    let n = fe(e, t);
...
var Q = class {
  ...
  createComponent(e) {
    ...
    return t = be(this, e), this._componentCache.set(e, t), t.cloneNode(true);
  }
  clearComponentCache() {
  ...
  find(e, t = this.rootEl ?? this._document) {
    let n = this.maybeFind(e, t);
    if (n === null) throw new Error(`query ${e} not found`);
    return n;
  }
  maybeFind(e, t = this.rootEl ?? this._document) {
...
var u = class o2 {
  ...
  static apply(e) {
    o2.strings = { ...we, ...e.providedStrings }, o2.i18n = e.i18n, o2.reportJson = e.reportJson;
  }
...
function xe(o5) {
  ...
  for (let n of Object.values(o5.audits)) if ((n.scoreDisplayMode === "not_applicable" || n.scoreDisplayMode === "not-applicable") && (n.scoreDisplayMode = "notApplicable"), n.scoreDisplayMode === "informative" && (n.score = 1), n.details) {
    if ((n.details.type === void 0 || n.details.type === "diagnostic") && (n.details.type = "debugdata"), n.details.type === "filmstrip") for (let r of n.details.items) r.data.startsWith(ye) || (r.data = ye + r.data);
...
var k = class o3 {
  static prepareReportResult(e) {
    ...
    for (let r of Object.values(t.categories)) r.auditRefs.forEach((i) => {
      ...
      if (t.stackPacks) {
        let s = [i.id, ...i.result.replacesAudits ?? []];
        t.stackPacks.forEach((c) => {
          let d = s.find((h) => c.descriptions[h]);
          d && c.descriptions[d] && (i.stackPacks = i.stackPacks || [], i.stackPacks.push({ title: c.title, iconDataURL: c.iconDataURL, description: c.descriptions[d] }));
        });
      }
    });
    return t;
  ...
  static classifyEntities(e, t) {
    ...
    if (i) for (let a of n) {
      ...
      let s = "";
      try {
        s = E.parseURL(l).origin;
      } catch {
      }
      if (!s) continue;
      let c = e.find((d) => d.origins.includes(s));
      c && (a.entity = c.name);
    }
  }
...
var G = class {
  ...
  renderAudit(e) {
    ...
    if (this.dom.find(".lh-chevron-container", r).append(this._createChevron()), this._setRatingClass(r, e.result.score, i), e.result.scoreDisplayMode === "error") {
      ...
      let p = this.dom.createChildOf(a, "div", "lh-audit-explanation");
    ...
    if (this.dom.createChildOf(h, "span").textContent = t.warningHeader, c.length === 1) h.append(this.dom.createTextNode(c.join("")));
      ...
      let p = this.dom.createChildOf(h, "ul");
      for (let g of c) {
        let b = this.dom.createChildOf(p, "li");
        b.textContent = g;
      }
    }
    return r;
  ...
  _createChevron() {
    let e = this.dom.createComponent("chevron");
  ...
  _renderGroupedAudits(e, t) {
    ...
    for (let [a, l] of n) {
      ...
      let s = t[a], [c, d] = this.renderAuditGroup(s);
      for (let h of l) c.insertBefore(this.renderAudit(h), d);
  ...
  renderClump(e, { auditRefsOrEls: t, description: n, openByDefault: r }) {
    ...
    c.textContent = `(${t.length})`;
    let d = t.map((p) => p instanceof HTMLElement ? p : this.renderAudit(p));
    a.append(...d);
    let h = this.dom.find(".lh-audit-group", i);
    if (n) {
  ...
  _auditHasWarning(e) {
    return !!e.result.warnings?.length;
  }
  _getClumpIdForAuditRef(e) {
    let t = e.result.scoreDisplayMode;
  ...
  render(e, t = {}, n) {
    ...
    for (let l of e.auditRefs) {
      ...
      let s = this._getClumpIdForAuditRef(l), c = i.get(s);
      c.push(l), i.set(s, c);
    }
    for (let l of i.values()) l.sort((s, c) => c.weight - s.weight);
    let a = i.get("failed")?.length;
    for (let [l, s] of i) {
...
var $ = class o4 {
  static getScreenshotPositions(e, t, n) {
    let r = gt(e), i = ke(r.x - t.width / 2, 0, n.width - t.width), a = ke(r.y - t.height / 2, 0, n.height - t.height);
  ...
  static installOverlayFeature(e) {
    ...
    n.classList.contains(a) || (n.classList.add(a), n.addEventListener("click", (l) => {
      ...
      d.append(g), d.addEventListener("click", () => d.remove());
    }));
  }
...
var ut = ["http://", "https://", "data:"];
var mt = ["bytes", "numeric", "ms", "timespanMs"];
var ee = class {
  constructor(e, t = {}) {
  ...
  render(e) {
    switch (e.type) {
      ...
      case "checklist":
        return this._renderChecklist(e);
      case "table":
      case "opportunity":
        return this._renderTable(e);
      case "network-tree":
      case "criticalrequestchain":
        return Y.render(this._dom, e, this);
      case "screenshot":
      case "debugdata":
      case "treemap-data":
        return null;
  ...
  _renderThumbnail(e) {
    let t = this._dom.createElement("img", "lh-thumbnail"), n = e;
    return t.src = n, t.title = n, t.alt = "", t;
  }
  _renderUnknown(e, t) {
    console.error(`Unknown details type: ${e}`, t);
    let n = this._dom.createElement("details", "lh-unknown");
  ...
  _renderTableValue(e, t) {
    ...
    if (typeof e == "object") switch (e.type) {
      ...
      case "text":
        return this._renderText(e.value);
    ...
    switch (t.valueType) {
      ...
      case "ms": {
        let n = { value: Number(e), granularity: t.granularity, displayUnit: t.displayUnit };
      ...
      case "url": {
        let n = String(e);
        return ut.some((r) => n.startsWith(r)) ? this.renderTextURL(n) : this._renderCode(n);
      }
      default:
  ...
  _getDerivedSubItemsHeading(e) {
    return e.subItemsHeading ? { key: e.subItemsHeading.key || "", valueType: e.subItemsHeading.valueType || e.valueType, granularity: e.subItemsHeading.granularity || e.granularity, displayUnit: e.subItemsHeading.displayUnit || e.displayUnit, label: "" } : null;
  }
  _renderTableRow(e, t) {
  ...
  _getEntityGroupItems(e) {
    ...
    for (let d of n) !d.key || i.has(d.key) || mt.includes(d.valueType) && a.push(d.key);
    let l = n[0].key;
    if (!l) return [];
  ...
  _renderTable(e) {
    ...
    if (i.length) for (let l of i) {
      let s = typeof l.entity == "string" ? l.entity : void 0, c = this._renderEntityGroupRow(l, e.headings);
      for (let h of e.items.filter((p) => p.entity === s)) c.append(this._renderTableRowsFromItem(h, e.headings));
      let d = this._dom.findAll("tr", c);
      s && d.length && (d.forEach((h) => h.dataset.entity = s), this._adornEntityGroupRow(d[0])), a.append(c);
    }
    else {
      let l = true;
      for (let s of e.items) {
        let c = this._renderTableRowsFromItem(s, e.headings), d = this._dom.findAll("tr", c), h = d[0];
        if (typeof s.entity == "string" && (h.dataset.entity = s.entity), e.isEntityGrouped && s.entity) h.classList.add("lh-row--group"), this._adornEntityGroupRow(h);
        else for (let p of d) p.classList.add(l ? "lh-row--even" : "lh-row--odd");
        l = !l, a.append(c);
      }
    }
    return t;
  ...
  _renderListValue(e) {
    return e.type === "node" ? this.renderNode(e) : e.type === "text" ? this._renderText(e.value) : this.render(e);
  }
  _renderList(e) {
    let t = this._dom.createElement("div", "lh-list");
    return e.items.forEach((n) => {
      if (n.type === "list-section") {
        let i = this._dom.createElement("div", "lh-list-section");
        n.title && this._dom.createChildOf(i, "div", "lh-list-section__title").append(this._dom.convertMarkdownLinkSnippets(n.title)), n.description && this._dom.createChildOf(i, "div", "lh-list-section__description").append(this._dom.convertMarkdownLinkSnippets(n.description));
        let a = this._renderListValue(n.value);
  ...
  renderNode(e) {
    let t = this._dom.createElement("span", "lh-node");
    if (e.nodeLabel) {
      let a = this._dom.createElement("div");
      a.textContent = e.nodeLabel, t.append(a);
    }
    if (e.snippet) {
      let a = this._dom.createElement("div");
      a.classList.add("lh-node__snippet"), a.textContent = e.snippet, t.append(a);
    }
  ...
  _renderCode(e) {
    let t = this._dom.createElement("pre", "lh-code");
    return t.textContent = e, t;
  }
};
var le = "\xA0";
var re = class {
  constructor(e) {
    e === "en-XA" && (e = "de"), this._locale = e, this._cachedNumberFormatters = /* @__PURE__ */ new Map();
  }
  _formatNumberWithGranularity(e, t, n = {}) {
    if (t !== void 0) {
      let a = -Math.log10(t);
    ...
    return r = this._cachedNumberFormatters.get(i), r || (r = new Intl.NumberFormat(this._locale, n), this._cachedNumberFormatters.set(i, r)), r.format(e).replace(" ", le);
  }
  formatNumber(e, t) {
  ...
  formatPercent(e) {
    return new Intl.NumberFormat(this._locale, { style: "percent" }).format(e);
  }
  formatBytesToKiB(e, t = void 0) {
    return this._formatNumberWithGranularity(e / 1024, t) + `${le}KiB`;
  }
  formatBytesToMiB(e, t = void 0) {
    return this._formatNumberWithGranularity(e / 1048576, t) + `${le}MiB`;
  }
  formatBytes(e, t = 1) {
    return this._formatNumberWithGranularity(e, t, { style: "unit", unit: "byte", unitDisplay: "long" });
  }
  formatBytesWithBestUnit(e, t = 0.1) {
    return e >= 1048576 ? this.formatBytesToMiB(e, t) : e >= 1024 ? this.formatBytesToKiB(e, t) : this._formatNumberWithGranularity(e, t, { style: "unit", unit: "byte", unitDisplay: "narrow" });
  }
  formatKbps(e, t = void 0) {
    return this._formatNumberWithGranularity(e, t, { style: "unit", unit: "kilobit-per-second", unitDisplay: "short" });
  }
  formatMilliseconds(e, t = void 0) {
    return this._formatNumberWithGranularity(e, t, { style: "unit", unit: "millisecond", unitDisplay: "short" });
  }
  formatSeconds(e, t = void 0) {
    return this._formatNumberWithGranularity(e / 1e3, t, { style: "unit", unit: "second", unitDisplay: "narrow" });
  }
  formatDateTime(e) {
    let t = { month: "short", day: "numeric", year: "numeric", hour: "numeric", minute: "numeric", timeZoneName: "short" }, n;
    try {
  ...
  formatDuration(e) {
    ...
    let n = [], r = { day: 60 * 60 * 24, hour: 60 * 60, minute: 60, second: 1 };
...
function Se(o5, e, t) {
  ...
  n.className = "", n.classList.add("lh-exp-gauge__wrapper", `lh-exp-gauge__wrapper--${k.calculateRating(t.score)}`), vt(o5, n, t);
}
function ft(o5, e, t) {
  t = t || o5 / 32;
...
function vt(o5, e, t) {
  let i = Number(t.score), { radiusInner: a, radiusOuter: l, circumferenceInner: s, circumferenceOuter: c, getArcLength: d, getMetricArcLength: h, endDiffInner: p, endDiffOuter: g, strokeWidth: b, strokeGap: _ } = ft(128, i), m = o5.find("svg.lh-exp-gauge", e);
  ...
  w.querySelectorAll(".metric").forEach((x) => {
    ...
    P.setAttribute("x", (C * Z).toFixed(2)), P.setAttribute("y", (C * J).toFixed(2)), U.setAttribute("x", (L * Z).toFixed(2)), U.setAttribute("y", (L * J).toFixed(2)), D && (T.appendChild(B), T.appendChild(K), T.appendChild(q), T.appendChild(P), T.appendChild(U), w.appendChild(T)), R -= Ie, H += j * 2 * Math.PI;
  });
  ...
  m.dataset.listenersSetup = true, De(m), m.addEventListener("pointerover", (x) => {
...
var Ce = "__lh__insights_audits_toggle_state_2";
var oe = class extends G {
  ...
  _renderMetric(e) {
    ...
    let l = this.dom.find(".lh-metric__description", t);
    if (l.append(this.dom.convertMarkdownLinkSnippets(e.result.description)), e.result.scoreDisplayMode === "error") {
      ...
      let s = this.dom.createChildOf(l, "span");
  ...
  overallImpact(e, t) {
    ...
    for (let [i, a] of Object.entries(e.result.metricSavings)) {
      ...
      if (!l || l.result.score === null) continue;
  ...
  _getRawInsightToggleState() {
    try {
      let e = window.localStorage.getItem(Ce);
  ...
  render(e, t, n) {
    ...
    if (h?.classList.add("lh-perf-audits--swappable", "lh-perf-audits--experimental"), d && (i.append(d), h && this.dom.registerSwappableSections(d, h)), this._getInsightToggleState() === "INSIGHTS" && requestAnimationFrame(() => {
      ...
      let g = Ee(this.dom);
      Se(this.dom, g, e), this.dom.find(".lh-score__gauge", i).replaceWith(g);
    }
    return i;
  }
...
var te = class {
  ...
  _renderReportHeader() {
    let e = this._dom.createComponent("heading"), t = this._dom.createComponent("scoresWrapper");
  ...
  _renderScoreGauges(e, t, n) {
    ...
    for (let a of Object.values(e.categories)) {
      ...
      c && (this._dom.safelySetHref(c, `#${a.id}`), c.addEventListener("click", (d) => {
        ...
        let h = c.getAttribute("href"), p = this._dom.rootEl;
        if (!h || !p) return;
...
var bt = typeof btoa < "u" ? btoa : (o5) => Buffer.from(o5).toString("base64");
var _t = typeof atob < "u" ? atob : (o5) => Buffer.from(o5, "base64").toString();
async function wt(o5, e) {
...
function yt(o5, e) {
  let t = _t(o5), n = Uint8Array.from(t, (r) => r.charCodeAt(0));
  return e.gzip ? window.pako.ungzip(n, { to: "string" }) : new TextDecoder().decode(n);
}
var Ae = { toBase64: wt, fromBase64: yt };
function se() {
...
async function Le(o5, e, t) {
  let n = new URL(e), r = !!window.CompressionStream;
  n.hash = await Ae.toBase64(JSON.stringify(o5), { gzip: r }), r && n.searchParams.set("gzip", "1"), window.open(n.toString(), t);
}
async function ze(o5) {
  let e = "viewer-" + ce(o5), t = se() + "/viewer/";
  await Le({ lhr: o5 }, t, e);
}
async function Me(o5) {
  let e = "viewer-" + ce(o5), t = se() + "/viewer/";
  xt({ lhr: o5 }, t, e);
}
function Te(o5) {
  if (!o5.audits["script-treemap-data"].details) throw new Error("no script treemap data found");
  let t = { lhr: { mainDocumentUrl: o5.mainDocumentUrl, finalUrl: o5.finalUrl, finalDisplayedUrl: o5.finalDisplayedUrl, audits: { "script-treemap-data": o5.audits["script-treemap-data"] }, configSettings: { locale: o5.configSettings.locale } } }, n = se() + "/treemap/", r = "treemap-" + ce(o5);
  Le(t, n, r);
}
var ie = class {
  constructor(e) {
  ...
  open(e) {
    this._toggleEl.classList.contains("lh-active") ? e.focus() : this._menuEl.addEventListener("transitionend", () => {
      e.focus();
    }, { once: true }), this._toggleEl.classList.add("lh-active"), this._toggleEl.setAttribute("aria-expanded", "true"), this._menuEl.addEventListener("focusout", this.onMenuFocusOut), this._dom.document().addEventListener("keydown", this.onDocumentKeyDown);
  }
  onToggleClick(e) {
...
var ae = class {
    ...
    if (!(!t || !t.hasAttribute("data-action"))) {
      switch (t.getAttribute("data-action")) {
        ...
        case "print-expanded":
          ...
          break;
        case "save-json": {
          let n = JSON.stringify(this.lhr, null, 2);
  ...
  onCopy(e) {
    this._copyAttempt && e.clipboardData && (e.preventDefault(), e.clipboardData.setData("text/plain", JSON.stringify(this.lhr, null, 2)), this._dom.fireEventOn("lh-log", this._dom.document(), { cmd: "log", msg: "Report JSON copied to clipboard" })), this._copyAttempt = false;
  }
  onCopyButtonClick() {
    this._dom.fireEventOn("lh-analytics", this._dom.document(), { name: "copy" });
    try {
      this._dom.document().queryCommandSupported("copy") && (this._copyAttempt = true, this._dom.document().execCommand("copy") || (this._copyAttempt = false, this._dom.fireEventOn("lh-log", this._dom.document(), { cmd: "warn", msg: "Your browser does not support copy to clipboard." })));
    } catch (e) {
      this._copyAttempt = false, this._dom.fireEventOn("lh-log", this._dom.document(), { cmd: "log", msg: e.message });
    }
  }
  onKeyUp(e) {
  ...
  expandAllDetails() {
    this._dom.findAll(".lh-categories details", this._dom.rootEl).map((t) => t.open = true);
  }
  collapseAllDetails() {
    this._dom.findAll(".lh-categories details", this._dom.rootEl).map((t) => t.open = false);
  }
  _print() {
  ...
  _setUpCollapseDetailsAfterPrinting() {
    "onbeforeprint" in self ? self.addEventListener("afterprint", this.collapseAllDetails) : self.matchMedia("print").addListener((t) => {
      t.matches ? this.expandAllDetails() : this.collapseAllDetails();
    });
  }
  _setupStickyHeader() {
    this.topbarEl = this._dom.find("div.lh-topbar", this._dom.rootEl), this.categoriesEl = this._dom.find("div.lh-categories", this._dom.rootEl), requestAnimationFrame(() => requestAnimationFrame(() => {
      try {
      ...
      let e = this._getScrollParent(this._dom.find(".lh-container", this._dom.rootEl));
      e.addEventListener("scroll", () => this._updateStickyHeader());
      let t = e instanceof window.Document ? document.documentElement : e;
      new window.ResizeObserver(() => this._updateStickyHeader()).observe(t);
    }));
  }
  _updateStickyHeader() {
    if (!this.stickyHeaderEl) return;
    let e = this.topbarEl.getBoundingClientRect().bottom, t = this.categoriesEl.getBoundingClientRect().top, n = e >= t, i = Array.from(this._dom.rootEl.querySelectorAll(".lh-category")).filter((h) => h.getBoundingClientRect().top - window.innerHeight / 2 < 0), a = i.length > 0 ? i.length - 1 : 0, l = this.stickyHeaderEl.querySelectorAll(".lh-gauge__wrapper, .lh-fraction__wrapper"), s = l[a], c = l[0].getBoundingClientRect().left, d = s.getBoundingClientRect().left - c;
...
var ne = class {
  ...
  addButton(e) {
    let t = this._dom.rootEl.querySelector(".lh-audit-group--metrics");
    if (!t) return;
  ...
  _setupMediaQueryListeners() {
    let e = self.matchMedia("(max-width: 500px)");
  ...
  _setupThirdPartyFilter() {
    ...
    Array.from(this._dom.rootEl.querySelectorAll("table.lh-table")).filter((i) => i.querySelector("td.lh-table-column--url, td.lh-table-column--source-location")).filter((i) => {
      ...
      let a = Et(i), l = a.filter((m) => !m.classList.contains("lh-sub-item-row")), s = this._getThirdPartyRows(l, E.getFinalDisplayedUrl(this.json)), c = a.some((m) => m.classList.contains("lh-row--even")), d = this._dom.createComponent("3pFilter"), h = this._dom.find("input", d);
  ...
  _getThirdPartyRows(e, t) {
    ...
    for (let a of e) {
      if (r) {
        ...
        if (!l) continue;
        let s = l.dataset.url;
        if (!s || !(E.getEntityFromUrl(s, this.json.entities) !== n)) continue;
      }
      i.push(a);
    }
    return i;
  ...
  _saveFile(e) {
    let t = e.type.match("json") ? ".json" : ".html", n = Fe({ finalDisplayedUrl: E.getFinalDisplayedUrl(this.json), fetchTime: this.json.fetchTime }) + t;
...
var zt = { registerLocaleData: At, hasLocale: Lt };
export {
  Q as DOM,
