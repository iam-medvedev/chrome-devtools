...
describe('DeviceModeModel', () => {
    ...
    it('does not change device metrics when safe-area insets are present', () => {
        ...
        try {
            ...
            deviceModeModel.emulate(EmulationModel.DeviceModeModel.Type.Device, deviceWithoutSafeArea, deviceWithoutSafeArea.modes[0]);
            ...
            deviceModeModel.emulate(EmulationModel.DeviceModeModel.Type.Device, deviceWithSafeArea, deviceWithSafeArea.modes[0]);
            sinon.assert.called(metricsSpy);
        ...
        try {
            ...
            assert.deepEqual(spy.lastCall.args[0], {
                displayCutoutConfig: {
                    ...
                    shape: "pill" /* Protocol.Overlay.DisplayCutoutShape.Pill */,
                    borderRadius: 19,
        ...
        try {
            ...
            assert.deepEqual(spy.lastCall.args[0], {
                displayCutoutConfig: {
                    ...
                    shape: "notch" /* Protocol.Overlay.DisplayCutoutShape.Notch */,
                    upperRadius: 5,
                    lowerRadius: 22,
                    contentColor: { r: 0, g: 0, b: 0, a: 1 },
                },
        ...
        try {
            ...
            assert.deepEqual(spy.lastCall.args[0], {
                displayCutoutConfig: {
                    ...
                    shape: "rectangle" /* Protocol.Overlay.DisplayCutoutShape.Rectangle */,
                    contentColor: { r: 0, g: 0, b: 0, a: 1 },
                },
            });
        }
        ...
        try {
            ...
            assert.deepEqual(spy.lastCall.args[0], {
                displayCutoutConfig: {
                    ...
                    shape: "circle" /* Protocol.Overlay.DisplayCutoutShape.Circle */,
                    cx: 180,
                    cy: 29,
                    radius: 14,
                    contentColor: { r: 0, g: 0, b: 0, a: 1 },
    ...
    it('uses modern default mobile user agent and metadata', () => {
        ...
        try {
            ...
            deviceModeModel.emulate('Responsive', null, null);
            const now = new Date();
