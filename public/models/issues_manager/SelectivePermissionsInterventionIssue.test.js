...
describeWithEnvironment('SelectivePermissionsInterventionIssue', () => {
    ...
    it('correctly creates an issue with valid details', () => {
        ...
        assert.strictEqual(interventionIssue.getCategory(), "SelectivePermissionsIntervention" /* IssuesManager.Issue.IssueCategory.SELECTIVE_PERMISSIONS_INTERVENTION */);
        assert.strictEqual(interventionIssue.getKind(), "PageError" /* IssuesManager.Issue.IssueKind.PAGE_ERROR */);
    ...
    it('generates a stable primary key', () => {
        const issue = createProtocolIssueWithDetails(issueDetails);
        const interventionIssue1 = IssuesManager.SelectivePermissionsInterventionIssue.SelectivePermissionsInterventionIssue.fromInspectorIssue(mockModel, issue)[0];
        const interventionIssue2 = IssuesManager.SelectivePermissionsInterventionIssue.SelectivePermissionsInterventionIssue.fromInspectorIssue(mockModel, issue)[0];
    ...
    it('generates different primary keys for different details', () => {
        ...
        const interventionIssue1 = IssuesManager.SelectivePermissionsInterventionIssue.SelectivePermissionsInterventionIssue.fromInspectorIssue(mockModel, issue1)[0];
        const interventionIssue2 = IssuesManager.SelectivePermissionsInterventionIssue.SelectivePermissionsInterventionIssue.fromInspectorIssue(mockModel, issue2)[0];
...
//# sourceMappingURL=SelectivePermissionsInterventionIssue.test.js.map