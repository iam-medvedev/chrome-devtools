...
import { DevToolsTimelineCategory, makeFakeSDKEventFromPayload, StubbedThread, } from '../../../test/unittests/front_end/helpers/TraceHelpers.js';
...
describeWithEnvironment('TimelineModel', function () {
    function traceWithEvents(events) {
        ...
        tracingModel.addEvents(preamble.concat(events));
    ...
    describe('Track.syncLikeEvents', function () {
        let nestableAsyncEvents;
        let nonNestableAsyncEvents;
        let syncEvents;
        const tracingModel = new TraceEngine.Legacy.TracingModel();
        ...
        function buildAsyncEvents(asyncPayloads) {
            const builtEvents = new Map();
