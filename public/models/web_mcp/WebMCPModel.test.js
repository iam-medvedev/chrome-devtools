...
describeWithEnvironment('WebMCPModel', () => {
    ...
    it('updates tools and dispatches event on toolsAdded', async () => {
        const toolsAddedPromise = webMCPModel.once("ToolsAdded" /* WebMCP.WebMCPModel.Events.TOOLS_ADDED */);
    ...
    it('updates tools and dispatches event on toolsRemoved', async () => {
        ...
        const toolsRemovedPromise = webMCPModel.once("ToolsRemoved" /* WebMCP.WebMCPModel.Events.TOOLS_REMOVED */);
