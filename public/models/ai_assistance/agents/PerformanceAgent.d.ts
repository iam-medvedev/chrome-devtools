...
export declare class PerformanceTraceContext extends ConversationContext<TimelineUtils.AIContext.AgentFocus> {
    #private;
    static full(parsedTrace: Trace.Handlers.Types.ParsedTrace, insightSet: Trace.Insights.Types.InsightSet | null, traceMetadata: Trace.Types.File.MetaData): PerformanceTraceContext;
