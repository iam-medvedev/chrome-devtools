...
export declare const PERF_AGENT_UNIT_FORMATTERS: UnitFormatters;
export declare class PerformanceTraceContext extends ConversationContext<TimelineUtils.AIContext.AgentFocus> {
    #private;
    static full(parsedTrace: Trace.Handlers.Types.ParsedTrace, insights: Trace.Insights.Types.TraceInsightSets, traceMetadata: Trace.Types.File.MetaData): PerformanceTraceContext;
    static fromInsight(parsedTrace: Trace.Handlers.Types.ParsedTrace, insights: Trace.Insights.Types.TraceInsightSets, traceMetadata: Trace.Types.File.MetaData, insight: Trace.Insights.Types.InsightModel): PerformanceTraceContext;
