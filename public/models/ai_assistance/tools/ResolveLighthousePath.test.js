...
describe('ResolveLighthousePathTool', () => {
    function createMockContext(overrides) {
        ...
        const mockNode = nodeExists ? {
            ...
            null;
        const mockDomModel = {
            pushNodeByPathToFrontend: async (path) => path === '1,HTML,1,BODY' ? pushNodeResult : null,
            nodeForId: (id) => id === resolvedNodeId ? mockNode : null,
        };
...
//# sourceMappingURL=ResolveLighthousePath.test.js.map