...
describeWithEnvironment('GetNetworkRequestDetailsTool', () => {
    ...
    it('retrieves details successfully', async () => {
        ...
        assert.include(response.result, 'Request: https://example.com/api/users');
        assert.include(response.result, 'Response status: 200');
    });
...
//# sourceMappingURL=GetNetworkRequestDetails.test.js.map