...
import { assertIsError, assertIsResult, makeFakeParsedTrace, stubPerformanceTraceFormatter, } from '../../../testing/AiAssistanceHelpers.js';
...
describe('GetTraceMainThreadSummaryTool', () => {
    ...
    it('returns formatted summary and widgets on success', async () => {
        const parsedTrace = makeFakeParsedTrace();
        const traceContext = AiAssistance.PerformanceTraceContext.PerformanceTraceContext.fromParsedTrace(parsedTrace, universe.targetManager, new Tracing.FreshRecording.Tracker(), universe.debuggerWorkspaceBinding);
        const mockBounds = { min: 10, max: 50 };
...
//# sourceMappingURL=GetTraceMainThreadSummary.test.js.map