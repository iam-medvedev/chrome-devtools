...
describe('FreestylerEvaluateAction', () => {
    ...
    describe('serialization', () => {
        it('should serialize primitive values correctly', async () => {
            assert.strictEqual(await AiAssistance.EvaluateAction.stringifyRemoteObject(new SDK.RemoteObject.LocalJSONObject('string')), '\'string\'');
            assert.strictEqual(await AiAssistance.EvaluateAction.stringifyRemoteObject(new SDK.RemoteObject.LocalJSONObject(999n)), '999n');
            assert.strictEqual(await AiAssistance.EvaluateAction.stringifyRemoteObject(new SDK.RemoteObject.LocalJSONObject(true)), 'true');
            assert.strictEqual(await AiAssistance.EvaluateAction.stringifyRemoteObject(new SDK.RemoteObject.LocalJSONObject(undefined)), 'undefined');
            assert.strictEqual(await AiAssistance.EvaluateAction.stringifyRemoteObject(new SDK.RemoteObject.LocalJSONObject(42)), '42');
            assert.strictEqual(await AiAssistance.EvaluateAction.stringifyRemoteObject(new SDK.RemoteObject.LocalJSONObject(Symbol('sym'))), 'Symbol(sym)');
        });
