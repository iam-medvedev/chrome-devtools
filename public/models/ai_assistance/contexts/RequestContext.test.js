...
describeWithMockConnection('RequestContext', function () {
    ...
    it('getPromptDetails describes the network request correctly', async function () {
        const request = SDK.NetworkRequest.NetworkRequest.create('requestId', urlString `https://www.example.com/api/users`, urlString `https://www.example.com/`, null, null, null);
