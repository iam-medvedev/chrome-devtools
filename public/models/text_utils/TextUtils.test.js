...
describe('TextUtils', () => {
    ...
    describe('FilterParser', () => {
        ...
        describe('parse', () => {
            ...
            it('returns correct results for a range of inputs', () => {
                ...
                assert.deepEqual(result[0], { key: undefined, regex: undefined, text: '//', negative: false }, 'result was incorrect');
                result = parse('/regex/');
                assert.deepEqual(result[0], { key: undefined, regex: /regex/im, text: undefined, negative: false }, 'result was incorrect');
                result = parse('/regex/ /another/');
                assert.deepEqual(result[0], { key: undefined, regex: /regex/im, text: undefined, negative: false }, 'result was incorrect');
                assert.deepEqual(result[1], { key: undefined, regex: /another/im, text: undefined, negative: false }, 'result was incorrect');
                result = parse(String.raw `/complex\/regex/`);
                assert.deepEqual(result[0], { key: undefined, regex: /complex\/regex/im, text: undefined, negative: false }, 'result was incorrect');
                ...
                assert.deepEqual(result[0], { key: undefined, regex: /regex with spaces/im, text: undefined, negative: false }, 'result was incorrect');
    ...
    describe('BalancedJSONTokenizer', function () {
        ...
        it('matches quotes', function () {
            ...
            const results = [];
            const callback = (str) => results.push(str);
