...
describe('ContentData', () => {
    ...
    it('converts to a Blob', async () => {
        ...
        assert.deepEqual(new Uint8Array(buffer), new Uint8Array([1, 2, 3, 4]));
    });
    ...
    it('converts to an image preview URL and caches the result', async () => {
        ...
        const textContent2 = new ContentData('large content', false, "text/html" /* MimeType.HTML */);
        ...
        const textContent3 = new ContentData('very large content', false, "text/html" /* MimeType.HTML */);
