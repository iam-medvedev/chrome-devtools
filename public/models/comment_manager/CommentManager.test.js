...
describe('CommentManager', () => {
    ...
    it('manages comment mode and dispatches COMMENT_MODE_CHANGED event', () => {
        const modeChangedEvents = [];
        manager.addEventListener("CommentModeChanged" /* CommentManager.CommentManager.Events.COMMENT_MODE_CHANGED */, event => {
    ...
    it('creates and retrieves comment threads and dispatches COMMENT_THREADS_CHANGED event', () => {
        ...
        manager.addEventListener("CommentThreadsChanged" /* CommentManager.CommentManager.Events.COMMENT_THREADS_CHANGED */, event => {
    ...
    it('does nothing when removing non-existent thread', () => {
        let eventCount = 0;
        manager.addEventListener("CommentThreadsChanged" /* CommentManager.CommentManager.Events.COMMENT_THREADS_CHANGED */, () => {
            eventCount++;
        });
