...
function createStubInstances(availability, projectSettings) {
    const inspectorFrontendHost = sinon.createStubInstance(class extends Host.InspectorFrontendHost.InspectorFrontendHostStub {
        events = sinon.createStubInstance(Common.ObjectWrapper.ObjectWrapper);
    });
...
describe('Persistence', () => {
    describe('AutomaticFileSystemManager', () => {
        describe('AutomaticFileSystemManager', () => {
            const AUTOMATIC_FILE_SYSTEM_CHANGED = "AutomaticFileSystemChanged" /* Persistence.AutomaticFileSystemManager.Events.AUTOMATIC_FILE_SYSTEM_CHANGED */;
            ...
            it('listens to FileSystemRemoved events', () => {
                ...
                sinon.assert.calledOnceWithMatch(inspectorFrontendHost.events.addEventListener, Host.InspectorFrontendHostAPI.Events.FileSystemRemoved, sinon.match.func, automaticFileSystemManager);
            });
            it('attempts to automatically connect the file system initially', () => {
                ...
                sinon.assert.calledOnceWithMatch(inspectorFrontendHost.connectAutomaticFileSystem, root, uuid, false, sinon.match.func);
            });
...
//# sourceMappingURL=AutomaticFileSystemManager.test.js.map