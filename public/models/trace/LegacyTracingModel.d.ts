...
export declare const eventPhasesOfInterestForTraceBounds: Set<Types.TraceEvents.Phase>;
...
export declare class Event {
    ...
    endTime?: number;
    duration?: number;
    protected constructor(categories: string | undefined, name: string, phase: Types.TraceEvents.Phase, startTime: number, thread: Thread);
...
export declare class ConstructedEvent extends Event {
    constructor(categories: string | undefined, name: string, phase: Types.TraceEvents.Phase, startTime: number, thread: Thread);
}
/**
...
export declare class PayloadEvent extends Event {
    ...
    protected constructor(categories: string | undefined, name: string, phase: Types.TraceEvents.Phase, startTime: number, thread: Thread, rawPayload: EventPayload);
...
export declare function timesForEventInMilliseconds(event: Event | Types.TraceEvents.TraceEventData): TimesForEventMs;
export declare function eventHasCategory(event: CompatibleTraceEvent, category: string): boolean;
export declare function phaseForEvent(event: Event | Types.TraceEvents.TraceEventData): Types.TraceEvents.Phase;
export declare function threadIDForEvent(event: Event | Types.TraceEvents.TraceEventData): Types.TraceEvents.ThreadID;
export declare function eventIsFromNewEngine(event: CompatibleTraceEvent | null): event is Types.TraceEvents.TraceEventData;
