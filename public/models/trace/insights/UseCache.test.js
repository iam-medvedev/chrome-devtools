...
describeWithEnvironment('UseCache', function () {
        ...
        it('should return true for cacheable requests', () => {
            const cacheableRequest = {
                args: {
                    data: {
                        protocol: 'https',
                        resourceType: "Script" /* Protocol.Network.ResourceType.Script */,
                        statusCode: 200,
                    },
                },
            };
        ...
        it('should return false for non-static resource types', () => {
            const nonCacheableRequest = {
                args: {
                    data: {
                        protocol: 'https',
                        resourceType: "XHR" /* Protocol.Network.ResourceType.XHR */,
                        statusCode: 200,
                    },
                },
            };
    ...
    describe('generateInsight', () => {
        it('generateInsight - no cacheable requests', async () => {
            ...
            const insight = getInsightOrError('UseCache', insights, getFirstOrError(data.Meta.navigationsByNavigationId.values()));
        ...
        it('generateInsight - cacheable requests', async () => {
            ...
            assert.deepEqual(gotCacheable[0].request.args.data.url, 'https://chromedevtools.github.io/performance-stories/lcp-large-image/app.css');
            // 10min
...
//# sourceMappingURL=UseCache.test.js.map