    ...
    describe('.simulateDownloadUntil', () => {
        describe('when maximumTime is not set', () => {
            ...
            it('should provide the correct values resumed large payload', () => {
                ...
                assert.deepEqual(connection.simulateDownloadUntil(bytesToDownload, { timeAlreadyElapsed: 5234 }), {
                    bytesDownloaded: bytesToDownload,
                    extraBytesDownloaded: 0,
                    congestionWindow: 68,
        ...
        describe('when maximumTime is set', () => {
            it('should provide the correct values less than TTFB', () => {
                const connection = new TCPConnection(100, Infinity, 0, false);
                assert.deepEqual(connection.simulateDownloadUntil(7300, { timeAlreadyElapsed: 0, maximumTimeToElapse: 68 }), {
                    bytesDownloaded: 7300,
                    extraBytesDownloaded: 0,
                    congestionWindow: 10,
                    roundTrips: 2,
            ...
            it('should provide the correct values just over TTFB', () => {
                const connection = new TCPConnection(100, Infinity, 0, false);
                assert.deepEqual(connection.simulateDownloadUntil(7300, { timeAlreadyElapsed: 0, maximumTimeToElapse: 250 }), {
                    bytesDownloaded: 7300,
                    extraBytesDownloaded: 0,
                    congestionWindow: 10,
                    roundTrips: 2,
            ...
            it('should all add up', () => {
                ...
                const secondSegment = connection.simulateDownloadUntil(bytesToDownload - firstSegment.bytesDownloaded, {
                ...
                const thirdSegment = connection.simulateDownloadUntil(bytesToDownload - firstSegment.bytesDownloaded - secondSegment.bytesDownloaded, { timeAlreadyElapsed: firstSegment.timeElapsed + secondSegment.timeElapsed });
