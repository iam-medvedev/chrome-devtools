    ...
    describe('parsing extension data added via the performance.measure/mark API', function () {
        ...
        describe('Track groups', () => {
            it('builds extension track data for grouped tracks correctly', async function () {
                ...
                const extensionHandlerOutput = await createTraceExtensionDataFromPerformanceAPITestInput(extensionDevToolsObjects.map((devtools, i) => ({
                    detail: { devtools },
                    name: 'A measurement',
    ...
    describe('parsing extension data added via the console.timeStamp API', function () {
        ...
        describe('Track groups', () => {
            it('builds extension track data for grouped tracks correctly', async function () {
                ...
                const extensionHandlerOutput = await createTraceExtensionDataFromConsoleAPITestInput(mockData.map(({ track, trackGroup }, i) => ({
                    track,
                    trackGroup,
                    name: 'A measurement',
                    // Use different timestamps
