...
export const VISIBLE_TRACE_EVENT_TYPES = new Set([
    ...
    "BeginFrame" /* Types.Events.Name.BEGIN_FRAME */,
    ...
    "DrawFrame" /* Types.Events.Name.DRAW_FRAME */,
    ...
    "FrameStartedLoading" /* Types.Events.Name.FRAME_STARTED_LOADING */,
    ...
    "LayoutShift" /* Types.Events.Name.LAYOUT_SHIFT */,
    "MajorGC" /* Types.Events.Name.MAJOR_GC */,
    "MarkDOMContent" /* Types.Events.Name.MARK_DOM_CONTENT */,
    "firstPaint" /* Types.Events.Name.MARK_FIRST_PAINT */,
    "firstContentfulPaint" /* Types.Events.Name.MARK_FCP */,
    "largestContentfulPaint::Candidate" /* Types.Events.Name.MARK_LCP_CANDIDATE */,
    "MarkLoad" /* Types.Events.Name.MARK_LOAD */,
    "MinorGC" /* Types.Events.Name.MINOR_GC */,
    "V8.OptimizeCode" /* Types.Events.Name.OPTIMIZE_CODE */,
    "Paint" /* Types.Events.Name.PAINT */,
    "PaintImage" /* Types.Events.Name.PAINT_IMAGE */,
    ...
    "RequestMainThreadFrame" /* Types.Events.Name.REQUEST_MAIN_THREAD_FRAME */,
    ...
    "UpdateLayer" /* Types.Events.Name.UPDATE_LAYER */,
