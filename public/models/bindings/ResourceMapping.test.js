  ...
  //# sourceURL=webpack:///src/foo.js`,
    ...
    beforeEach(async () => {
        ...
        SCRIPTS.forEach(({ scriptId, startLine, startColumn, endLine, endColumn, sourceURL, hasSourceURLComment }) => {
            debuggerModel.parsedScriptSource(scriptId, sourceURL, startLine, startColumn, endLine, endColumn, executionContextId, hash, undefined, undefined, hasSourceURLComment, false, length, false, null, null, null, null, embedderName, null);
        });
    ...
    describe('functionBoundsAtRawLocation', () => {
        function makeLocation(script, line, column) {
