...
describe('MockCDPConnection', () => {
    it('handles sync success results', async () => {
        ...
        connection.setSuccessHandler('Runtime.evaluate', params => {
            return { result: { type: 'number', value: params.expression.length } };
        });
        ...
        assert.deepEqual(response.result, { result: { type: 'number', value: 5 } });
    });
...
//# sourceMappingURL=MockCDPConnection.test.js.map