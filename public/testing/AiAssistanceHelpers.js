...
export function createNetworkRequest() {
    const networkRequest = SDK.NetworkRequest.NetworkRequest.create('requestId', Platform.DevToolsPath.urlString `https://www.example.com/script.js`, Platform.DevToolsPath.urlString ``, null, null, null);
