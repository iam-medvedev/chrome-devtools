...
export declare const colorCanvas: () => LoggingConfig.ConfigStringBuilder;
...
export declare const copyColor: () => LoggingConfig.ConfigStringBuilder;
...
export declare const elementsTreeOutline: () => LoggingConfig.ConfigStringBuilder;
...
export declare const fullAccessibilityTree: () => LoggingConfig.ConfigStringBuilder;
