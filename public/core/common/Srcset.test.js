...
describe('Srcset', () => {
    it('parses a single URL', () => {
        ...
        assert.deepEqual(tokens, [
            { type: 1 /* Common.Srcset.TokenType.URL */, value: 'image.png' },
        ]);
    });
    it('parses a single URL with descriptor', () => {
        ...
        assert.deepEqual(tokens, [
            { type: 1 /* Common.Srcset.TokenType.URL */, value: 'image.png' },
            { type: 0 /* Common.Srcset.TokenType.LITERAL */, value: ' 1x' },
        ]);
    });
    it('parses multiple URLs', () => {
        ...
        assert.deepEqual(tokens, [
            { type: 1 /* Common.Srcset.TokenType.URL */, value: 'image.png' },
            { type: 0 /* Common.Srcset.TokenType.LITERAL */, value: ' 1x,' },
            { type: 0 /* Common.Srcset.TokenType.LITERAL */, value: ' ' },
            { type: 1 /* Common.Srcset.TokenType.URL */, value: 'image2.png' },
            { type: 0 /* Common.Srcset.TokenType.LITERAL */, value: ' 2x' },
        ]);
    });
    ...
    it('parses URLs with commas not followed by spaces (non-spec compliant behavior)', () => {
        ...
        const tokens = Common.Srcset.parseSrcset('image.png,image2.png');
        assert.deepEqual(tokens, [
            { type: 1 /* Common.Srcset.TokenType.URL */, value: 'image.png,image2.png' },
        ]);
    });
...
//# sourceMappingURL=Srcset.test.js.map