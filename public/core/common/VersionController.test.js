...
describe('VersionController', () => {
    ...
    describe('updateVersion', () => {
        it('initializes version settings with the current version if the setting doesn\'t exist yet', () => {
            ...
            assert.strictEqual(globalStorage.get(Common.VersionController.VersionController.GLOBAL_VERSION_SETTING_NAME), currentVersion);
            assert.strictEqual(syncedStorage.get(Common.VersionController.VersionController.SYNCED_VERSION_SETTING_NAME), currentVersion);
            assert.strictEqual(localStorage.get(Common.VersionController.VersionController.LOCAL_VERSION_SETTING_NAME), currentVersion);
        });
...
describe('updateVersionFrom38To39', () => {
    ...
    describe('updateVersionFrom39To40', () => {
        let settings;
        let customNetworkCondSetting;
        let preferredNetworkCondSetting;
        beforeEach(() => {
            const mockStore = new InMemoryStorage();
            const syncedStorage = new Common.Settings.SettingsStorage({}, mockStore);
            const globalStorage = new Common.Settings.SettingsStorage({}, mockStore);
...
//# sourceMappingURL=VersionController.test.js.map