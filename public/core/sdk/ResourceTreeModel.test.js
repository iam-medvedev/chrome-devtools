...
describeWithEnvironment('ResourceTreeModel', () => {
    ...
    it('updates frame url and dispatches events on navigatedWithinDocument', async () => {
        ...
        resourceTreeModel.addEventListener(SDK.ResourceTreeModel.Events.FrameNavigatedWithinDocument, frameNavigatedWithinDocumentSpy);
        connection.dispatchEvent('Page.navigatedWithinDocument', {
            frameId: mainFrame.id,
            url: newUrl,
            navigationType: "historyApi" /* Protocol.Page.NavigatedWithinDocumentEventNavigationType.HistoryAPI */,
        }, undefined);
