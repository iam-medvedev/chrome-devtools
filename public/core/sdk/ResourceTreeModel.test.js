...
describeWithMockConnection('ResourceTreeModel', () => {
    ...
    function frameNavigatedEvent(parentId, id) {
        return {
            frame: {
                id: id ?? 'main',
                parentId,
    ...
    it('rebuilds the resource tree upon bfcache-navigation', async () => {
        ...
        dispatchEvent(target, 'Page.frameNavigated', { ...frameNavigatedEvent(), type: "BackForwardCacheRestore" /* Protocol.Page.NavigationType.BackForwardCacheRestore */ });
