...
export declare function formatMicroSecondsAsMillisFixed(time: Platform.Timing.MicroSeconds, fractionDigits?: number): string;
export declare function formatMicroSecondsAsMillisFixedExpanded(time: Platform.Timing.MicroSeconds, fractionDigits?: number): string;
