...
Common2.Revealer.registerRevealer({
  ...
  destination: Common2.Revealer.RevealerDestination.DEVELOPER_RESOURCES_PANEL,
  async loadRevealer() {
    const DeveloperResources = await loadDeveloperResourcesModule();
...
Common3.Revealer.registerRevealer({
  ...
  destination: Common3.Revealer.RevealerDestination.ISSUES_VIEW,
  async loadRevealer() {
    const Issues = await loadIssuesModule();
...
UI6.ViewManager.registerViewExtension({
  ...
  commandPrompt: () => i18nString(UIStrings6.showRequestConditions),
  title: () => i18nString(UIStrings6.networkRequestConditions),
  persistence: "closeable",
  order: 60,
  async loadView() {
    const Network = await loadNetworkModule();
...
UI6.ActionRegistration.registerActionExtension({
  ...
  category: "NETWORK",
  title: () => i18nString(UIStrings6.addNetworkRequestBlockingOrThrottlingPattern),
  iconClass: "plus",
  contextTypes() {
...
UI6.ActionRegistration.registerActionExtension({
  ...
  category: "NETWORK",
  title: () => i18nString(UIStrings6.removeAllNetworkRequestBlockingOrThrottlingPatterns),
  iconClass: "clear",
  contextTypes() {
    return maybeRetrieveContextTypes2((Network) => [Network.RequestConditionsDrawer.RequestConditionsDrawer]);
  },
...
Common6.Revealer.registerRevealer({
  ...
  destination: Common6.Revealer.RevealerDestination.NETWORK_PANEL,
  async loadRevealer() {
    const Network = await loadNetworkModule();
...
Common8.Revealer.registerRevealer({
  ...
  destination: Common8.Revealer.RevealerDestination.TIMELINE_PANEL,
  async loadRevealer() {
    const Timeline = await loadTimelineModule();
...
Common9.Runnable.registerEarlyInitializationRunnable(WorkerMainImpl.instance);
