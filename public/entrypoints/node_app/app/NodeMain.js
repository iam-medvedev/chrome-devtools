...
export class NodeChildTargetManager extends SDK.SDKModel.SDKModel {
    ...
    attachedToTarget({ sessionId, targetInfo }) {
        ...
        if (targetInfo.type === 'node_worker') {
            ...
            target = this.#targetManager.createTarget(targetInfo.targetId, name, SDK.Target.Type.NODE, null, undefined, undefined, new ProtocolClient.DevToolsCDPConnection.DevToolsCDPConnection(connection));
        }
