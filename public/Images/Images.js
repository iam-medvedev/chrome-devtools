...
style.setProperty('--image-file-account-box', 'url(\"' + new URL(new URL('account-box.svg', import.meta.url).href, import.meta.url).toString() + '\")');
...
style.setProperty('--image-file-globe', 'url(\"' + new URL(new URL('globe.svg', import.meta.url).href, import.meta.url).toString() + '\")');
