...
style.setProperty('--image-file-add-photo', 'url(\"' + new URL(new URL('add-photo.svg', import.meta.url).href, import.meta.url).toString() + '\")');
...
style.setProperty('--image-file-folder-asterisk', 'url(\"' + new URL(new URL('folder-asterisk.svg', import.meta.url).href, import.meta.url).toString() + '\")');
style.setProperty('--image-file-folder-off', 'url(\"' + new URL(new URL('folder-off.svg', import.meta.url).href, import.meta.url).toString() + '\")');
